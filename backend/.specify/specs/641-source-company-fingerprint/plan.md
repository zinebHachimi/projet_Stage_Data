# Plan: 641 — Source Company Plugin: Fingerprint
...
Fingerprint's careers board is hosted on Greenhouse at the slug
`fingerprint`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fingerprint` plugin.
- Deliverables: package files, `Site.FINGERPRINT` enum value, the
...
- `packages/plugins/source-company-fingerprint` (new)
