# Plan: 513 — Source Company Plugin: Paystack
...
Paystack's careers board is hosted on Greenhouse at the slug
`paystack`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-paystack` plugin.
- Deliverables: package files, `Site.PAYSTACK` enum value, the
...
- `packages/plugins/source-company-paystack` (new)
