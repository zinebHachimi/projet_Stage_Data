# Plan: 608 — Source Company Plugin: Altruist
...
Altruist's careers board is hosted on Greenhouse at the slug
`altruist`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-altruist` plugin.
- Deliverables: package files, `Site.ALTRUIST` enum value, the
...
- `packages/plugins/source-company-altruist` (new)
