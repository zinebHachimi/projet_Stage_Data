# Plan: 915 — Source Company Plugin: PubMatic
...
PubMatic's careers board is hosted on Greenhouse at the slug
`pubmatic`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pubmatic` plugin.
- Deliverables: package files, `Site.PUBMATIC` enum value, the
...
- `packages/plugins/source-company-pubmatic` (new)
