# Plan: 587 — Source Company Plugin: FanDuel
...
FanDuel's careers board is hosted on Greenhouse at the slug
`fanduel`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fanduel` plugin.
- Deliverables: package files, `Site.FANDUEL` enum value, the
...
- `packages/plugins/source-company-fanduel` (new)
