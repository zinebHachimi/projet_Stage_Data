# Plan: 447 — Source Company Plugin: Lucid Motors
...
Lucid Motors's careers board is hosted on Greenhouse at the slug
`lucidmotors`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-lucidmotors` plugin.
- Deliverables: package files, `Site.LUCIDMOTORS` enum value, the
...
- `packages/plugins/source-company-lucidmotors` (new)
