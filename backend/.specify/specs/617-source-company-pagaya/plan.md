# Plan: 617 — Source Company Plugin: Pagaya
...
Pagaya's careers board is hosted on Greenhouse at the slug
`pagaya`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pagaya` plugin.
- Deliverables: package files, `Site.PAGAYA` enum value, the
...
- `packages/plugins/source-company-pagaya` (new)
