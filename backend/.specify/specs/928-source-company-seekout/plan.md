# Plan: 928 — Source Company Plugin: SeekOut
...
SeekOut's careers board is hosted on Greenhouse at the slug
`seekout`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-seekout` plugin.
- Deliverables: package files, `Site.SEEKOUT` enum value, the
...
- `packages/plugins/source-company-seekout` (new)
