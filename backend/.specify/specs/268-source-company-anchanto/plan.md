# Plan: 268 — Source Company Plugin: Anchanto
...
Anchanto's careers board is hosted on Greenhouse at the slug
`anchanto`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-anchanto` plugin.
- Deliverables: package files, `Site.ANCHANTO` enum value, the
...
- `packages/plugins/source-company-anchanto` (new)
