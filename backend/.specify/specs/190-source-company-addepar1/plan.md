# Plan: 190 — Source Company Plugin: Addepar
...
Addepar's careers board is hosted on Greenhouse at the slug
`addepar1`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-addepar1` plugin.
- Deliverables: package files, `Site.ADDEPAR1` enum value, the
...
- `packages/plugins/source-company-addepar1` (new)
