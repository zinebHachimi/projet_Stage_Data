# Plan: 646 — Source Company Plugin: Vast
...
Vast's careers board is hosted on Greenhouse at the slug
`vast`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-vast` plugin.
- Deliverables: package files, `Site.VAST` enum value, the
...
- `packages/plugins/source-company-vast` (new)
