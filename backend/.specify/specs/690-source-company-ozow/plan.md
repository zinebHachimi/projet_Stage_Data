# Plan: 690 — Source Company Plugin: Ozow
...
Ozow's careers board is hosted on Greenhouse at the slug
`ozow`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ozow` plugin.
- Deliverables: package files, `Site.OZOW` enum value, the
...
- `packages/plugins/source-company-ozow` (new)
