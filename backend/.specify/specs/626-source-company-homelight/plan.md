# Plan: 626 — Source Company Plugin: HomeLight
...
HomeLight's careers board is hosted on Greenhouse at the slug
`homelight`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-homelight` plugin.
- Deliverables: package files, `Site.HOMELIGHT` enum value, the
...
- `packages/plugins/source-company-homelight` (new)
