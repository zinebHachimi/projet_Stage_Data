# Plan: 473 — Source Company Plugin: Dashlane
...
Dashlane's careers board is hosted on Greenhouse at the slug
`dashlane`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-dashlane` plugin.
- Deliverables: package files, `Site.DASHLANE` enum value, the
...
- `packages/plugins/source-company-dashlane` (new)
