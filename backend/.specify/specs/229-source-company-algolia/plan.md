# Plan: 229 — Source Company Plugin: Algolia
...
Algolia's careers board is hosted on Greenhouse at the slug
`algolia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-algolia` plugin.
- Deliverables: package files, `Site.ALGOLIA` enum value, the
...
- `packages/plugins/source-company-algolia` (new)
