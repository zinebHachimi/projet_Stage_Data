# Plan: 562 — Source Company Plugin: Lunar Energy
...
Lunar Energy's careers board is hosted on Greenhouse at the slug
`lunarenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-lunarenergy` plugin.
- Deliverables: package files, `Site.LUNAR_ENERGY` enum value, the
...
- `packages/plugins/source-company-lunarenergy` (new)
