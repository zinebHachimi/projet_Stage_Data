# Plan: 869 — Source Company Plugin: Innovid
...
Innovid's careers board is hosted on Greenhouse at the slug
`innovid`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-innovid` plugin.
- Deliverables: package files, `Site.INNOVID` enum value, the
...
- `packages/plugins/source-company-innovid` (new)
