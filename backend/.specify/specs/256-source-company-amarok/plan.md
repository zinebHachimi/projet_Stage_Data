# Plan: 256 — Source Company Plugin: AMAROK
...
AMAROK's careers board is hosted on Greenhouse at the slug
`amarok`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amarok` plugin.
- Deliverables: package files, `Site.AMAROK` enum value, the
...
- `packages/plugins/source-company-amarok` (new)
