# Plan: 501 — Source Company Plugin: Watershed Informatics
...
Watershed Informatics's careers board is hosted on Greenhouse at the slug
`watershed`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-watershed` plugin.
- Deliverables: package files, `Site.WATERSHED` enum value, the
...
- `packages/plugins/source-company-watershed` (new)
