# Plan: 553 — Source Company Plugin: Apptronik
...
Apptronik's careers board is hosted on Greenhouse at the slug
`apptronik`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apptronik` plugin.
- Deliverables: package files, `Site.APPTRONIK` enum value, the
...
- `packages/plugins/source-company-apptronik` (new)
