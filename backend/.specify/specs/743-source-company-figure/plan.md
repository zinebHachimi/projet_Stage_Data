# Plan: 743 — Source Company Plugin: Figure Lending
...
Figure Lending's careers board is hosted on Greenhouse at the slug
`figure`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-figure` plugin.
- Deliverables: package files, `Site.FIGURE_LENDING` enum value, the
...
- `packages/plugins/source-company-figure` (new)
