# Plan: 706 — Source Company Plugin: Self Financial
...
Self Financial's careers board is hosted on Greenhouse at the slug
`selffinancial`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-selffinancial` plugin.
- Deliverables: package files, `Site.SELF_FINANCIAL` enum value, the
...
- `packages/plugins/source-company-selffinancial` (new)
