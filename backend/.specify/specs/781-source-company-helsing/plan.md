# Plan: 781 — Source Company Plugin: Helsing
...
Helsing's careers board is hosted on Greenhouse at the slug
`helsing`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-helsing` plugin.
- Deliverables: package files, `Site.HELSING` enum value, the
...
- `packages/plugins/source-company-helsing` (new)
