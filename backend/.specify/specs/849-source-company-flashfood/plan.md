# Plan: 849 — Source Company Plugin: Flashfood
...
Flashfood's careers board is hosted on Greenhouse at the slug
`flashfood`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-flashfood` plugin.
- Deliverables: package files, `Site.FLASHFOOD` enum value, the
...
- `packages/plugins/source-company-flashfood` (new)
