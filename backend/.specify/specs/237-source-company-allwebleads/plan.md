# Plan: 237 — Source Company Plugin: AWL
...
AWL's careers board is hosted on Greenhouse at the slug
`allwebleads`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-allwebleads` plugin.
- Deliverables: package files, `Site.ALLWEBLEADS` enum value, the
...
- `packages/plugins/source-company-allwebleads` (new)
