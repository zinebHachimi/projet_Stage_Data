# Plan: 429 — Source Company Plugin: Abnormal Security
...
Abnormal Security's careers board is hosted on Greenhouse at the slug
`abnormalsecurity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-abnormalsecurity` plugin.
- Deliverables: package files, `Site.ABNORMALSECURITY` enum value, the
...
- `packages/plugins/source-company-abnormalsecurity` (new)
