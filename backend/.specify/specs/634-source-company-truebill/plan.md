# Plan: 634 — Source Company Plugin: Rocket Money
...
Rocket Money's careers board is hosted on Greenhouse at the slug
`truebill`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-truebill` plugin.
- Deliverables: package files, `Site.ROCKET_MONEY` enum value, the
...
- `packages/plugins/source-company-truebill` (new)
