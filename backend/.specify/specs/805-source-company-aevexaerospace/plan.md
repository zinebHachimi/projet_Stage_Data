# Plan: 805 — Source Company Plugin: AEVEX Aerospace
...
AEVEX Aerospace's careers board is hosted on Greenhouse at the slug
`aevexaerospace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aevexaerospace` plugin.
- Deliverables: package files, `Site.AEVEX_AEROSPACE` enum value, the
...
- `packages/plugins/source-company-aevexaerospace` (new)
