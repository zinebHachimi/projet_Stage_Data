# Plan: 558 — Source Company Plugin: Diligent Robotics
...
Diligent Robotics's careers board is hosted on Greenhouse at the slug
`diligentrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-diligentrobotics` plugin.
- Deliverables: package files, `Site.DILIGENT_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-diligentrobotics` (new)
