# Plan: 253 — Source Company Plugin: Alveole
...
Alveole's careers board is hosted on Greenhouse at the slug
`alveole`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alveole` plugin.
- Deliverables: package files, `Site.ALVEOLE` enum value, the
...
- `packages/plugins/source-company-alveole` (new)
