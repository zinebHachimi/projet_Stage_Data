# Plan: 657 — Source Company Plugin: Mochi Health
...
Mochi Health's careers board is hosted on Greenhouse at the slug
`mochihealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mochihealth` plugin.
- Deliverables: package files, `Site.MOCHI_HEALTH` enum value, the
...
- `packages/plugins/source-company-mochihealth` (new)
