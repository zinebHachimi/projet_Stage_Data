# Plan: 725 — Source Company Plugin: Mesh Payments
...
Mesh Payments's careers board is hosted on Greenhouse at the slug
`mesh`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mesh` plugin.
- Deliverables: package files, `Site.MESH_PAYMENTS` enum value, the
...
- `packages/plugins/source-company-mesh` (new)
