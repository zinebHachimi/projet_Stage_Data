# Plan: 456 — Source Company Plugin: Imply
...
Imply's careers board is hosted on Greenhouse at the slug
`imply`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-imply` plugin.
- Deliverables: package files, `Site.IMPLY` enum value, the
...
- `packages/plugins/source-company-imply` (new)
