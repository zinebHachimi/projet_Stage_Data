# Plan: 968 — Source Company Plugin: Vox Media
...
Vox Media's careers board is hosted on Greenhouse at the slug
`voxmedia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-voxmedia` plugin.
- Deliverables: package files, `Site.VOX_MEDIA` enum value, the
...
- `packages/plugins/source-company-voxmedia` (new)
