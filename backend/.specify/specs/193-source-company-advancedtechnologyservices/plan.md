# Plan: 193 — Source Company Plugin: Advanced Technology Services
...
Advanced Technology Services's careers board is hosted on Greenhouse at the slug
`advancedtechnologyservices`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-advancedtechnologyservices` plugin.
- Deliverables: package files, `Site.ADVANCEDTECHNOLOGYSERVICES` enum value, the
...
- `packages/plugins/source-company-advancedtechnologyservices` (new)
