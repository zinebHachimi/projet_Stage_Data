# Plan: 257 — Source Company Plugin: Ambient Enterprises
...
Ambient Enterprises's careers board is hosted on Greenhouse at the slug
`ambiententerprises`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ambiententerprises` plugin.
- Deliverables: package files, `Site.AMBIENTENTERPRISES` enum value, the
...
- `packages/plugins/source-company-ambiententerprises` (new)
