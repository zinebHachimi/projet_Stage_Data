# Plan: 275 — Source Company Plugin: Antora Energy
...
Antora Energy's careers board is hosted on Greenhouse at the slug
`antora`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-antora` plugin.
- Deliverables: package files, `Site.ANTORA` enum value, the
...
- `packages/plugins/source-company-antora` (new)
