# Plan: 881 — Source Company Plugin: Matic Insurance
...
Matic Insurance's careers board is hosted on Greenhouse at the slug
`matic`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-matic` plugin.
- Deliverables: package files, `Site.MATIC_INSURANCE` enum value, the
...
- `packages/plugins/source-company-matic` (new)
