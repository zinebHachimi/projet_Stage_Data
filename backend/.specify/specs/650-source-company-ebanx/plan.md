# Plan: 650 — Source Company Plugin: EBANX
...
EBANX's careers board is hosted on Greenhouse at the slug
`ebanx`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ebanx` plugin.
- Deliverables: package files, `Site.EBANX` enum value, the
...
- `packages/plugins/source-company-ebanx` (new)
