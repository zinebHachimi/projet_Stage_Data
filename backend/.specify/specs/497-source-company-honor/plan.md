# Plan: 497 — Source Company Plugin: Honor
...
Honor's careers board is hosted on Greenhouse at the slug
`honor`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-honor` plugin.
- Deliverables: package files, `Site.HONOR` enum value, the
...
- `packages/plugins/source-company-honor` (new)
