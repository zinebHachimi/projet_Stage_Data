# Plan: 873 — Source Company Plugin: ITS Logistics
...
ITS Logistics's careers board is hosted on Greenhouse at the slug
`itslogisticsllc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-itslogisticsllc` plugin.
- Deliverables: package files, `Site.ITS_LOGISTICS` enum value, the
...
- `packages/plugins/source-company-itslogisticsllc` (new)
