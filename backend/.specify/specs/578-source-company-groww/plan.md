# Plan: 578 — Source Company Plugin: Groww
...
Groww's careers board is hosted on Greenhouse at the slug
`groww`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-groww` plugin.
- Deliverables: package files, `Site.GROWW` enum value, the
...
- `packages/plugins/source-company-groww` (new)
