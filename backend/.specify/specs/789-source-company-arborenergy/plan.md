# Plan: 789 — Source Company Plugin: Arbor Energy
...
Arbor Energy's careers board is hosted on Greenhouse at the slug
`arborenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-arborenergy` plugin.
- Deliverables: package files, `Site.ARBOR_ENERGY` enum value, the
...
- `packages/plugins/source-company-arborenergy` (new)
