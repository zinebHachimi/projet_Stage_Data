# Plan: 922 — Source Company Plugin: Rocket Lawyer
...
Rocket Lawyer's careers board is hosted on Greenhouse at the slug
`rocketlawyer`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-rocketlawyer` plugin.
- Deliverables: package files, `Site.ROCKET_LAWYER` enum value, the
...
- `packages/plugins/source-company-rocketlawyer` (new)
