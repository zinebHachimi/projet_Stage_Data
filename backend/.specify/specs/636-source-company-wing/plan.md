# Plan: 636 — Source Company Plugin: Wing
...
Wing's careers board is hosted on Greenhouse at the slug
`wing`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-wing` plugin.
- Deliverables: package files, `Site.WING` enum value, the
...
- `packages/plugins/source-company-wing` (new)
