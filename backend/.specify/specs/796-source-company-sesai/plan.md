# Plan: 796 — Source Company Plugin: SES AI
...
SES AI's careers board is hosted on Greenhouse at the slug
`sesai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sesai` plugin.
- Deliverables: package files, `Site.SES_AI` enum value, the
...
- `packages/plugins/source-company-sesai` (new)
