# Plan: 588 — Source Company Plugin: Underdog
...
Underdog's careers board is hosted on Greenhouse at the slug
`underdogfantasy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-underdogfantasy` plugin.
- Deliverables: package files, `Site.UNDERDOG` enum value, the
...
- `packages/plugins/source-company-underdogfantasy` (new)
