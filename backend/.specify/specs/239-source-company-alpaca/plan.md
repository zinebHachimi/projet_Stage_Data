# Plan: 239 — Source Company Plugin: Alpaca 
...
Alpaca 's careers board is hosted on Greenhouse at the slug
`alpaca`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alpaca` plugin.
- Deliverables: package files, `Site.ALPACA` enum value, the
...
- `packages/plugins/source-company-alpaca` (new)
