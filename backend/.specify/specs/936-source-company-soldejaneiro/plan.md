# Plan: 936 — Source Company Plugin: Sol de Janeiro
...
Sol de Janeiro's careers board is hosted on Greenhouse at the slug
`soldejaneiro`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-soldejaneiro` plugin.
- Deliverables: package files, `Site.SOL_DE_JANEIRO` enum value, the
...
- `packages/plugins/source-company-soldejaneiro` (new)
