# Plan: 918 — Source Company Plugin: Recorded Future
...
Recorded Future's careers board is hosted on Greenhouse at the slug
`recordedfuture`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-recordedfuture` plugin.
- Deliverables: package files, `Site.RECORDED_FUTURE` enum value, the
...
- `packages/plugins/source-company-recordedfuture` (new)
