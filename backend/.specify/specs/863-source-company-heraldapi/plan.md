# Plan: 863 — Source Company Plugin: Herald
...
Herald's careers board is hosted on Greenhouse at the slug
`heraldapi`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-heraldapi` plugin.
- Deliverables: package files, `Site.HERALD` enum value, the
...
- `packages/plugins/source-company-heraldapi` (new)
