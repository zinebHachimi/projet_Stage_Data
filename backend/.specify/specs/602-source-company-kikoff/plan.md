# Plan: 602 — Source Company Plugin: Kikoff
...
Kikoff's careers board is hosted on Greenhouse at the slug
`kikoff`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-kikoff` plugin.
- Deliverables: package files, `Site.KIKOFF` enum value, the
...
- `packages/plugins/source-company-kikoff` (new)
