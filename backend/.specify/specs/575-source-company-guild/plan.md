# Plan: 575 — Source Company Plugin: Guild
...
Guild's careers board is hosted on Greenhouse at the slug
`guild`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-guild` plugin.
- Deliverables: package files, `Site.GUILD` enum value, the
...
- `packages/plugins/source-company-guild` (new)
