# Plan: 250 — Source Company Plugin: AltScore
...
AltScore's careers board is hosted on Greenhouse at the slug
`altscore`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-altscore` plugin.
- Deliverables: package files, `Site.ALTSCORE` enum value, the
...
- `packages/plugins/source-company-altscore` (new)
