# Plan: 953 — Source Company Plugin: Dutchie
...
Dutchie's careers board is hosted on Greenhouse at the slug
`thedutchie`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thedutchie` plugin.
- Deliverables: package files, `Site.DUTCHIE` enum value, the
...
- `packages/plugins/source-company-thedutchie` (new)
