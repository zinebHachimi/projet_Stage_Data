# Plan: 835 — Source Company Plugin: Defense Unicorns
...
Defense Unicorns's careers board is hosted on Greenhouse at the slug
`defenseunicorns`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-defenseunicorns` plugin.
- Deliverables: package files, `Site.DEFENSE_UNICORNS` enum value, the
...
- `packages/plugins/source-company-defenseunicorns` (new)
