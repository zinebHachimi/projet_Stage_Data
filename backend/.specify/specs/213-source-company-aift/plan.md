# Plan: 213 — Source Company Plugin: AIFT
...
AIFT's careers board is hosted on Greenhouse at the slug
`aift`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aift` plugin.
- Deliverables: package files, `Site.AIFT` enum value, the
...
- `packages/plugins/source-company-aift` (new)
