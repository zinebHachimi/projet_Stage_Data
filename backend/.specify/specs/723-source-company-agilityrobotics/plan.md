# Plan: 723 — Source Company Plugin: Agility Robotics
...
Agility Robotics's careers board is hosted on Greenhouse at the slug
`agilityrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agilityrobotics` plugin.
- Deliverables: package files, `Site.AGILITY_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-agilityrobotics` (new)
