# Plan: 191 — Source Company Plugin: Adelphi Research
...
Adelphi Research's careers board is hosted on Greenhouse at the slug
`adelphiresearch`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-adelphiresearch` plugin.
- Deliverables: package files, `Site.ADELPHIRESEARCH` enum value, the
...
- `packages/plugins/source-company-adelphiresearch` (new)
