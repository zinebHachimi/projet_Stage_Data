# Plan: 291 — Source Company Plugin: Appfire
...
Appfire's careers board is hosted on Greenhouse at the slug
`appfire`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-appfire` plugin.
- Deliverables: package files, `Site.APPFIRE` enum value, the
...
- `packages/plugins/source-company-appfire` (new)
