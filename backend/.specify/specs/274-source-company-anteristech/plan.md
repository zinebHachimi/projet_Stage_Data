# Plan: 274 — Source Company Plugin: Anteris Technologies
...
Anteris Technologies's careers board is hosted on Greenhouse at the slug
`anteristech`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-anteristech` plugin.
- Deliverables: package files, `Site.ANTERISTECH` enum value, the
...
- `packages/plugins/source-company-anteristech` (new)
