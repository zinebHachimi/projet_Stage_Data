# Plan: 457 — Source Company Plugin: Motive
...
Motive's careers board is hosted on Greenhouse at the slug
`motive`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-motive` plugin.
- Deliverables: package files, `Site.MOTIVE` enum value, the
...
- `packages/plugins/source-company-motive` (new)
