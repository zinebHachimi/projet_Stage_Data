# Plan: 541 — Source Company Plugin: Cybereason
...
Cybereason's careers board is hosted on Greenhouse at the slug
`cybereason`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cybereason` plugin.
- Deliverables: package files, `Site.CYBEREASON` enum value, the
...
- `packages/plugins/source-company-cybereason` (new)
