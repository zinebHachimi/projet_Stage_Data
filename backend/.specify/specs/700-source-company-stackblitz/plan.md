# Plan: 700 — Source Company Plugin: StackBlitz
...
StackBlitz's careers board is hosted on Greenhouse at the slug
`stackblitz`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-stackblitz` plugin.
- Deliverables: package files, `Site.STACKBLITZ` enum value, the
...
- `packages/plugins/source-company-stackblitz` (new)
