# Plan: 666 — Source Company Plugin: Nexamp
...
Nexamp's careers board is hosted on Greenhouse at the slug
`nexamp`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nexamp` plugin.
- Deliverables: package files, `Site.NEXAMP` enum value, the
...
- `packages/plugins/source-company-nexamp` (new)
