# Plan: 837 — Source Company Plugin: Dorsia
...
Dorsia's careers board is hosted on Greenhouse at the slug
`dorsia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-dorsia` plugin.
- Deliverables: package files, `Site.DORSIA` enum value, the
...
- `packages/plugins/source-company-dorsia` (new)
