# Plan: 872 — Source Company Plugin: Integrated Specialty Coverages
...
Integrated Specialty Coverages's careers board is hosted on Greenhouse at the slug
`isccareers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-isccareers` plugin.
- Deliverables: package files, `Site.INTEGRATED_SPECIALTY_COVERAGES` enum value, the
...
- `packages/plugins/source-company-isccareers` (new)
