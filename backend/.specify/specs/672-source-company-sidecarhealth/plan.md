# Plan: 672 — Source Company Plugin: Sidecar Health
...
Sidecar Health's careers board is hosted on Greenhouse at the slug
`sidecarhealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sidecarhealth` plugin.
- Deliverables: package files, `Site.SIDECAR_HEALTH` enum value, the
...
- `packages/plugins/source-company-sidecarhealth` (new)
