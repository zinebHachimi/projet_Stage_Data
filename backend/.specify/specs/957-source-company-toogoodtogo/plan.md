# Plan: 957 — Source Company Plugin: Too Good To Go
...
Too Good To Go's careers board is hosted on Greenhouse at the slug
`toogoodtogo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-toogoodtogo` plugin.
- Deliverables: package files, `Site.TOO_GOOD_TO_GO` enum value, the
...
- `packages/plugins/source-company-toogoodtogo` (new)
