# Plan: 799 — Source Company Plugin: tastytrade
...
tastytrade's careers board is hosted on Greenhouse at the slug
`tastytrade`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tastytrade` plugin.
- Deliverables: package files, `Site.TASTYTRADE` enum value, the
...
- `packages/plugins/source-company-tastytrade` (new)
