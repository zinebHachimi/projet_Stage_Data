# Plan: 901 — Source Company Plugin: OpenTable
...
OpenTable's careers board is hosted on Greenhouse at the slug
`opentable`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-opentable` plugin.
- Deliverables: package files, `Site.OPENTABLE` enum value, the
...
- `packages/plugins/source-company-opentable` (new)
