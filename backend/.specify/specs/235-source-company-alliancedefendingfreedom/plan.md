# Plan: 235 — Source Company Plugin: Alliance Defending Freedom
...
Alliance Defending Freedom's careers board is hosted on Greenhouse at the slug
`alliancedefendingfreedom`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alliancedefendingfreedom` plugin.
- Deliverables: package files, `Site.ALLIANCEDEFENDINGFREEDOM` enum value, the
...
- `packages/plugins/source-company-alliancedefendingfreedom` (new)
