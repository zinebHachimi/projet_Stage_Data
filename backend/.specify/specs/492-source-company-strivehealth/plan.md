# Plan: 492 — Source Company Plugin: Strive Health
...
Strive Health's careers board is hosted on Greenhouse at the slug
`strivehealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-strivehealth` plugin.
- Deliverables: package files, `Site.STRIVEHEALTH` enum value, the
...
- `packages/plugins/source-company-strivehealth` (new)
