# Plan: 907 — Source Company Plugin: Palmetto Clean Technology
...
Palmetto Clean Technology's careers board is hosted on Greenhouse at the slug
`palmettocleantech`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-palmettocleantech` plugin.
- Deliverables: package files, `Site.PALMETTO_CLEAN_TECHNOLOGY` enum value, the
...
- `packages/plugins/source-company-palmettocleantech` (new)
