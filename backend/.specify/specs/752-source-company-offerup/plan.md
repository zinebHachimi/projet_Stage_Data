# Plan: 752 — Source Company Plugin: OfferUp
...
OfferUp's careers board is hosted on Greenhouse at the slug
`offerup`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-offerup` plugin.
- Deliverables: package files, `Site.OFFERUP` enum value, the
...
- `packages/plugins/source-company-offerup` (new)
