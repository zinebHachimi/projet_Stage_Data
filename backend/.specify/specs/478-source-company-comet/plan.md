# Plan: 478 — Source Company Plugin: Comet
...
Comet's careers board is hosted on Greenhouse at the slug
`comet`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-comet` plugin.
- Deliverables: package files, `Site.COMET` enum value, the
...
- `packages/plugins/source-company-comet` (new)
