# Plan: 686 — Source Company Plugin: Cleo AI
...
Cleo AI's careers board is hosted on Greenhouse at the slug
`cleo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cleo` plugin.
- Deliverables: package files, `Site.CLEO_AI` enum value, the
...
- `packages/plugins/source-company-cleo` (new)
