# Plan: 614 — Source Company Plugin: Bombas
...
Bombas's careers board is hosted on Greenhouse at the slug
`bombas`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-bombas` plugin.
- Deliverables: package files, `Site.BOMBAS` enum value, the
...
- `packages/plugins/source-company-bombas` (new)
