# Plan: 797 — Source Company Plugin: Solaris
...
Solaris's careers board is hosted on Greenhouse at the slug
`solarisbank`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-solarisbank` plugin.
- Deliverables: package files, `Site.SOLARIS` enum value, the
...
- `packages/plugins/source-company-solarisbank` (new)
