# Plan: 682 — Source Company Plugin: Camus Energy
...
Camus Energy's careers board is hosted on Greenhouse at the slug
`camusenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-camusenergy` plugin.
- Deliverables: package files, `Site.CAMUS_ENERGY` enum value, the
...
- `packages/plugins/source-company-camusenergy` (new)
