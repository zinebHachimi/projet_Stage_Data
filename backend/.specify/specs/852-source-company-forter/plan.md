# Plan: 852 — Source Company Plugin: Forter
...
Forter's careers board is hosted on Greenhouse at the slug
`forter`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-forter` plugin.
- Deliverables: package files, `Site.FORTER` enum value, the
...
- `packages/plugins/source-company-forter` (new)
