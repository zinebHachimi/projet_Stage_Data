# Plan: 836 — Source Company Plugin: Digital Extremes
...
Digital Extremes's careers board is hosted on Greenhouse at the slug
`digitalextremes`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-digitalextremes` plugin.
- Deliverables: package files, `Site.DIGITAL_EXTREMES` enum value, the
...
- `packages/plugins/source-company-digitalextremes` (new)
