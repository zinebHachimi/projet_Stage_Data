# Plan: 224 — Source Company Plugin: Akuity
...
Akuity's careers board is hosted on Greenhouse at the slug
`akuity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-akuity` plugin.
- Deliverables: package files, `Site.AKUITY` enum value, the
...
- `packages/plugins/source-company-akuity` (new)
