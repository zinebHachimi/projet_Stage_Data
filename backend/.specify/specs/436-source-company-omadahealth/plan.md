# Plan: 436 — Source Company Plugin: Omada Health
...
Omada Health's careers board is hosted on Greenhouse at the slug
`omadahealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-omadahealth` plugin.
- Deliverables: package files, `Site.OMADAHEALTH` enum value, the
...
- `packages/plugins/source-company-omadahealth` (new)
