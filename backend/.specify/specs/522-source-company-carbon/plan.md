# Plan: 522 — Source Company Plugin: Carbon
...
Carbon's careers board is hosted on Greenhouse at the slug
`carbon`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-carbon` plugin.
- Deliverables: package files, `Site.CARBON` enum value, the
...
- `packages/plugins/source-company-carbon` (new)
