# Plan: 633 — Source Company Plugin: Sparkfund
...
Sparkfund's careers board is hosted on Greenhouse at the slug
`sparkfund`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sparkfund` plugin.
- Deliverables: package files, `Site.SPARKFUND` enum value, the
...
- `packages/plugins/source-company-sparkfund` (new)
