# Plan: 803 — Source Company Plugin: Zuora
...
Zuora's careers board is hosted on Greenhouse at the slug
`zuora`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-zuora` plugin.
- Deliverables: package files, `Site.ZUORA` enum value, the
...
- `packages/plugins/source-company-zuora` (new)
