# Plan: 573 — Source Company Plugin: Rockstar Games
...
Rockstar Games's careers board is hosted on Greenhouse at the slug
`rockstargames`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-rockstargames` plugin.
- Deliverables: package files, `Site.ROCKSTAR_GAMES` enum value, the
...
- `packages/plugins/source-company-rockstargames` (new)
