# Plan: 252 — Source Company Plugin: Alumni Ventures
...
Alumni Ventures's careers board is hosted on Greenhouse at the slug
`alumniventures`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alumniventures` plugin.
- Deliverables: package files, `Site.ALUMNIVENTURES` enum value, the
...
- `packages/plugins/source-company-alumniventures` (new)
