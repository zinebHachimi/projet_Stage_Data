# Plan: 225 — Source Company Plugin: Alamar Biosciences
...
Alamar Biosciences's careers board is hosted on Greenhouse at the slug
`alamarbiosciences`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alamarbiosciences` plugin.
- Deliverables: package files, `Site.ALAMARBIOSCIENCES` enum value, the
...
- `packages/plugins/source-company-alamarbiosciences` (new)
