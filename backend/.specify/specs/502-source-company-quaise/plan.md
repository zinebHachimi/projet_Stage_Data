# Plan: 502 — Source Company Plugin: Quaise Energy
...
Quaise Energy's careers board is hosted on Greenhouse at the slug
`quaise`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-quaise` plugin.
- Deliverables: package files, `Site.QUAISE` enum value, the
...
- `packages/plugins/source-company-quaise` (new)
