# Plan: 931 — Source Company Plugin: ShipBob
...
ShipBob's careers board is hosted on Greenhouse at the slug
`shipbobinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-shipbobinc` plugin.
- Deliverables: package files, `Site.SHIPBOB` enum value, the
...
- `packages/plugins/source-company-shipbobinc` (new)
