# Plan: 933 — Source Company Plugin: Skillsoft
...
Skillsoft's careers board is hosted on Greenhouse at the slug
`skillsoft`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-skillsoft` plugin.
- Deliverables: package files, `Site.SKILLSOFT` enum value, the
...
- `packages/plugins/source-company-skillsoft` (new)
