# Plan: 211 — Source Company Plugin: AgWest Farm Credit
...
AgWest Farm Credit's careers board is hosted on Greenhouse at the slug
`agwestfarmcredit`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agwestfarmcredit` plugin.
- Deliverables: package files, `Site.AGWESTFARMCREDIT` enum value, the
...
- `packages/plugins/source-company-agwestfarmcredit` (new)
