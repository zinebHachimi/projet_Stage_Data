# Plan: 601 — Source Company Plugin: Cuyana
...
Cuyana's careers board is hosted on Greenhouse at the slug
`cuyana`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cuyana` plugin.
- Deliverables: package files, `Site.CUYANA` enum value, the
...
- `packages/plugins/source-company-cuyana` (new)
