# Plan: 642 — Source Company Plugin: Incode Technologies
...
Incode Technologies's careers board is hosted on Greenhouse at the slug
`incode`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-incode` plugin.
- Deliverables: package files, `Site.INCODE_TECHNOLOGIES` enum value, the
...
- `packages/plugins/source-company-incode` (new)
