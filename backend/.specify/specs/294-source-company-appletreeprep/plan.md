# Plan: 294 — Source Company Plugin: AppleTree Prep
...
AppleTree Prep's careers board is hosted on Greenhouse at the slug
`appletreeprep`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-appletreeprep` plugin.
- Deliverables: package files, `Site.APPLETREEPREP` enum value, the
...
- `packages/plugins/source-company-appletreeprep` (new)
