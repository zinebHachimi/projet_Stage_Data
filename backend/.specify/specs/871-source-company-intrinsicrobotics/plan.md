# Plan: 871 — Source Company Plugin: Intrinsic
...
Intrinsic's careers board is hosted on Greenhouse at the slug
`intrinsicrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-intrinsicrobotics` plugin.
- Deliverables: package files, `Site.INTRINSIC` enum value, the
...
- `packages/plugins/source-company-intrinsicrobotics` (new)
