# Plan: 929 — Source Company Plugin: Seoul Robotics
...
Seoul Robotics's careers board is hosted on Greenhouse at the slug
`seoulrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-seoulrobotics` plugin.
- Deliverables: package files, `Site.SEOUL_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-seoulrobotics` (new)
