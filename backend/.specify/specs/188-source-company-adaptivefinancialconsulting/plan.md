# Plan: 188 — Source Company Plugin: Adaptive Financial Consulting
...
Adaptive Financial Consulting's careers board is hosted on Greenhouse at the slug
`adaptivefinancialconsulting`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-adaptivefinancialconsulting` plugin.
- Deliverables: package files, `Site.ADAPTIVEFINANCIALCONSULTING` enum value, the
...
- `packages/plugins/source-company-adaptivefinancialconsulting` (new)
