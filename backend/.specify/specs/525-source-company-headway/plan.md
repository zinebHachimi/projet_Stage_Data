# Plan: 525 — Source Company Plugin: Headway
...
Headway's careers board is hosted on Greenhouse at the slug
`headway`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-headway` plugin.
- Deliverables: package files, `Site.HEADWAY` enum value, the
...
- `packages/plugins/source-company-headway` (new)
