# Plan: 764 — Source Company Plugin: Hubble Network
...
Hubble Network's careers board is hosted on Greenhouse at the slug
`hubblenetwork`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hubblenetwork` plugin.
- Deliverables: package files, `Site.HUBBLE_NETWORK` enum value, the
...
- `packages/plugins/source-company-hubblenetwork` (new)
