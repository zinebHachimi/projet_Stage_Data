# Plan: 856 — Source Company Plugin: Glean
...
Glean's careers board is hosted on Greenhouse at the slug
`gleanwork`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gleanwork` plugin.
- Deliverables: package files, `Site.GLEAN` enum value, the
...
- `packages/plugins/source-company-gleanwork` (new)
