# Plan: 967 — Source Company Plugin: Viral Nation
...
Viral Nation's careers board is hosted on Greenhouse at the slug
`viralnation`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-viralnation` plugin.
- Deliverables: package files, `Site.VIRAL_NATION` enum value, the
...
- `packages/plugins/source-company-viralnation` (new)
