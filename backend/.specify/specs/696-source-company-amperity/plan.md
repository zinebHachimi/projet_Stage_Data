# Plan: 696 — Source Company Plugin: Amperity
...
Amperity's careers board is hosted on Greenhouse at the slug
`amperity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amperity` plugin.
- Deliverables: package files, `Site.AMPERITY` enum value, the
...
- `packages/plugins/source-company-amperity` (new)
