# Plan: 448 — Source Company Plugin: Nuro
...
Nuro's careers board is hosted on Greenhouse at the slug
`nuro`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nuro` plugin.
- Deliverables: package files, `Site.NURO` enum value, the
...
- `packages/plugins/source-company-nuro` (new)
