# Plan: 222 — Source Company Plugin: AKKO
...
AKKO's careers board is hosted on Greenhouse at the slug
`akko`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-akko` plugin.
- Deliverables: package files, `Site.AKKO` enum value, the
...
- `packages/plugins/source-company-akko` (new)
