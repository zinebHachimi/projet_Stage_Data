# Plan: 521 — Source Company Plugin: Group14 Technologies
...
Group14 Technologies's careers board is hosted on Greenhouse at the slug
`group14`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-group14` plugin.
- Deliverables: package files, `Site.GROUP14` enum value, the
...
- `packages/plugins/source-company-group14` (new)
