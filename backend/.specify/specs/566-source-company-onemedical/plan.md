# Plan: 566 — Source Company Plugin: One Medical
...
One Medical's careers board is hosted on Greenhouse at the slug
`onemedical`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-onemedical` plugin.
- Deliverables: package files, `Site.ONE_MEDICAL` enum value, the
...
- `packages/plugins/source-company-onemedical` (new)
