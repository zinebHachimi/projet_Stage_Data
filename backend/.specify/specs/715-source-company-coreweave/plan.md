# Plan: 715 — Source Company Plugin: CoreWeave
...
CoreWeave's careers board is hosted on Greenhouse at the slug
`coreweave`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-coreweave` plugin.
- Deliverables: package files, `Site.COREWEAVE` enum value, the
...
- `packages/plugins/source-company-coreweave` (new)
