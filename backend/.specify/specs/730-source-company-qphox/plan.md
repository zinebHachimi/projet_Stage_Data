# Plan: 730 — Source Company Plugin: QphoX
...
QphoX's careers board is hosted on Greenhouse at the slug
`qphox`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-qphox` plugin.
- Deliverables: package files, `Site.QPHOX` enum value, the
...
- `packages/plugins/source-company-qphox` (new)
