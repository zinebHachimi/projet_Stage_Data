# Plan: 861 — Source Company Plugin: Ghost Story Games
...
Ghost Story Games's careers board is hosted on Greenhouse at the slug
`gsgcareers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gsgcareers` plugin.
- Deliverables: package files, `Site.GHOST_STORY_GAMES` enum value, the
...
- `packages/plugins/source-company-gsgcareers` (new)
