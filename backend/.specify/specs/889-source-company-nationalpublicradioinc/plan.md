# Plan: 889 — Source Company Plugin: NPR (National Public Radio)
...
NPR (National Public Radio)'s careers board is hosted on Greenhouse at the slug
`nationalpublicradioinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nationalpublicradioinc` plugin.
- Deliverables: package files, `Site.NPR_NATIONAL_PUBLIC_RADIO` enum value, the
...
- `packages/plugins/source-company-nationalpublicradioinc` (new)
