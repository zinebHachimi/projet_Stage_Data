# Plan: 729 — Source Company Plugin: Parloa
...
Parloa's careers board is hosted on Greenhouse at the slug
`parloa`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-parloa` plugin.
- Deliverables: package files, `Site.PARLOA` enum value, the
...
- `packages/plugins/source-company-parloa` (new)
