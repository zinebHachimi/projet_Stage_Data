# Plan: 884 — Source Company Plugin: Metropolis Technologies
...
Metropolis Technologies's careers board is hosted on Greenhouse at the slug
`metropolis`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-metropolis` plugin.
- Deliverables: package files, `Site.METROPOLIS_TECHNOLOGIES` enum value, the
...
- `packages/plugins/source-company-metropolis` (new)
