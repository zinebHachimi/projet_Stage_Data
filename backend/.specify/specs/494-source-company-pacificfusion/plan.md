# Plan: 494 — Source Company Plugin: Pacific Fusion
...
Pacific Fusion's careers board is hosted on Greenhouse at the slug
`pacificfusion`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pacificfusion` plugin.
- Deliverables: package files, `Site.PACIFICFUSION` enum value, the
...
- `packages/plugins/source-company-pacificfusion` (new)
