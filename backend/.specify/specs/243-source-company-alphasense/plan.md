# Plan: 243 — Source Company Plugin: AlphaSense
...
AlphaSense's careers board is hosted on Greenhouse at the slug
`alphasense`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alphasense` plugin.
- Deliverables: package files, `Site.ALPHASENSE` enum value, the
...
- `packages/plugins/source-company-alphasense` (new)
