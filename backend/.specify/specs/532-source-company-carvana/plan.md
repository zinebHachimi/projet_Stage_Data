# Plan: 532 — Source Company Plugin: Carvana
...
Carvana's careers board is hosted on Greenhouse at the slug
`carvana`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-carvana` plugin.
- Deliverables: package files, `Site.CARVANA` enum value, the
...
- `packages/plugins/source-company-carvana` (new)
