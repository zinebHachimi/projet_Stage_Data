# Plan: 970 — Source Company Plugin: Wildlife Studios
...
Wildlife Studios's careers board is hosted on Greenhouse at the slug
`wildlifestudios`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-wildlifestudios` plugin.
- Deliverables: package files, `Site.WILDLIFE_STUDIOS` enum value, the
...
- `packages/plugins/source-company-wildlifestudios` (new)
