# Plan: 206 — Source Company Plugin: AGE Solutions
...
AGE Solutions's careers board is hosted on Greenhouse at the slug
`agecareers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agecareers` plugin.
- Deliverables: package files, `Site.AGECAREERS` enum value, the
...
- `packages/plugins/source-company-agecareers` (new)
