# Plan: 293 — Source Company Plugin: Appier
...
Appier's careers board is hosted on Greenhouse at the slug
`appier`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-appier` plugin.
- Deliverables: package files, `Site.APPIER` enum value, the
...
- `packages/plugins/source-company-appier` (new)
