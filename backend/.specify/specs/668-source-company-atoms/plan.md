# Plan: 668 — Source Company Plugin: Atoms Tech
...
Atoms Tech's careers board is hosted on Greenhouse at the slug
`atoms`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-atoms` plugin.
- Deliverables: package files, `Site.ATOMS_TECH` enum value, the
...
- `packages/plugins/source-company-atoms` (new)
