# Plan: 828 — Source Company Plugin: Collibra
...
Collibra's careers board is hosted on Greenhouse at the slug
`collibra`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-collibra` plugin.
- Deliverables: package files, `Site.COLLIBRA` enum value, the
...
- `packages/plugins/source-company-collibra` (new)
