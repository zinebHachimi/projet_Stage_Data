# Plan: 581 — Source Company Plugin: Parachute Home
...
Parachute Home's careers board is hosted on Greenhouse at the slug
`parachutehome`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-parachutehome` plugin.
- Deliverables: package files, `Site.PARACHUTE_HOME` enum value, the
...
- `packages/plugins/source-company-parachutehome` (new)
