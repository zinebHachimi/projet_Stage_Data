# Plan: 904 — Source Company Plugin: Origis Energy
...
Origis Energy's careers board is hosted on Greenhouse at the slug
`origisenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-origisenergy` plugin.
- Deliverables: package files, `Site.ORIGIS_ENERGY` enum value, the
...
- `packages/plugins/source-company-origisenergy` (new)
