# Plan: 615 — Source Company Plugin: Overstory
...
Overstory's careers board is hosted on Greenhouse at the slug
`overstory`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-overstory` plugin.
- Deliverables: package files, `Site.OVERSTORY` enum value, the
...
- `packages/plugins/source-company-overstory` (new)
