# Plan: 616 — Source Company Plugin: Stackline
...
Stackline's careers board is hosted on Greenhouse at the slug
`stackline`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-stackline` plugin.
- Deliverables: package files, `Site.STACKLINE` enum value, the
...
- `packages/plugins/source-company-stackline` (new)
