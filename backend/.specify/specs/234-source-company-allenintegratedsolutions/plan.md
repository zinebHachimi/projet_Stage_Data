# Plan: 234 — Source Company Plugin: Allen Integrated Solutions
...
Allen Integrated Solutions's careers board is hosted on Greenhouse at the slug
`allenintegratedsolutions`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-allenintegratedsolutions` plugin.
- Deliverables: package files, `Site.ALLENINTEGRATEDSOLUTIONS` enum value, the
...
- `packages/plugins/source-company-allenintegratedsolutions` (new)
