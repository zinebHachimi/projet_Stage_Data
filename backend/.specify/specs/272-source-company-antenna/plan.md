# Plan: 272 — Source Company Plugin: Antenna
...
Antenna's careers board is hosted on Greenhouse at the slug
`antenna`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-antenna` plugin.
- Deliverables: package files, `Site.ANTENNA` enum value, the
...
- `packages/plugins/source-company-antenna` (new)
