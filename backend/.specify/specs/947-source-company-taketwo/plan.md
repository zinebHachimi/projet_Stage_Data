# Plan: 947 — Source Company Plugin: Take-Two Interactive
...
Take-Two Interactive's careers board is hosted on Greenhouse at the slug
`taketwo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-taketwo` plugin.
- Deliverables: package files, `Site.TAKE_TWO_INTERACTIVE` enum value, the
...
- `packages/plugins/source-company-taketwo` (new)
