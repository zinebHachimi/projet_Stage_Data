# Plan: 258 — Source Company Plugin: Amca
...
Amca's careers board is hosted on Greenhouse at the slug
`amca`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amca` plugin.
- Deliverables: package files, `Site.AMCA` enum value, the
...
- `packages/plugins/source-company-amca` (new)
