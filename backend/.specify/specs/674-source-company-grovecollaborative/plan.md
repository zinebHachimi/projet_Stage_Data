# Plan: 674 — Source Company Plugin: Grove Collaborative
...
Grove Collaborative's careers board is hosted on Greenhouse at the slug
`grovecollaborative`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-grovecollaborative` plugin.
- Deliverables: package files, `Site.GROVE_COLLABORATIVE` enum value, the
...
- `packages/plugins/source-company-grovecollaborative` (new)
