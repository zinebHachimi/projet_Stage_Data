# Plan: 605 — Source Company Plugin: Suitsupply
...
Suitsupply's careers board is hosted on Greenhouse at the slug
`suitsupply`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-suitsupply` plugin.
- Deliverables: package files, `Site.SUITSUPPLY` enum value, the
...
- `packages/plugins/source-company-suitsupply` (new)
