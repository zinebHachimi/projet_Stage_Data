# Plan: 579 — Source Company Plugin: Ritual
...
Ritual's careers board is hosted on Greenhouse at the slug
`ritual`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ritual` plugin.
- Deliverables: package files, `Site.RITUAL` enum value, the
...
- `packages/plugins/source-company-ritual` (new)
