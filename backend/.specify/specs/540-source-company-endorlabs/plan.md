# Plan: 540 — Source Company Plugin: Endor Labs
...
Endor Labs's careers board is hosted on Greenhouse at the slug
`endorlabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-endorlabs` plugin.
- Deliverables: package files, `Site.ENDOR_LABS` enum value, the
...
- `packages/plugins/source-company-endorlabs` (new)
