# Plan: 484 — Source Company Plugin: Knock
...
Knock's careers board is hosted on Greenhouse at the slug
`knock`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-knock` plugin.
- Deliverables: package files, `Site.KNOCK` enum value, the
...
- `packages/plugins/source-company-knock` (new)
