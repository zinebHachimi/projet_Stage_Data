# Plan: 621 — Source Company Plugin: Counterpart
...
Counterpart's careers board is hosted on Greenhouse at the slug
`counterpart`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-counterpart` plugin.
- Deliverables: package files, `Site.COUNTERPART` enum value, the
...
- `packages/plugins/source-company-counterpart` (new)
