# Plan: 962 — Source Company Plugin: Uber Freight
...
Uber Freight's careers board is hosted on Greenhouse at the slug
`uberfreight`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-uberfreight` plugin.
- Deliverables: package files, `Site.UBER_FREIGHT` enum value, the
...
- `packages/plugins/source-company-uberfreight` (new)
