# Plan: 480 — Source Company Plugin: Inflection AI
...
Inflection AI's careers board is hosted on Greenhouse at the slug
`inflectionai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-inflectionai` plugin.
- Deliverables: package files, `Site.INFLECTIONAI` enum value, the
...
- `packages/plugins/source-company-inflectionai` (new)
