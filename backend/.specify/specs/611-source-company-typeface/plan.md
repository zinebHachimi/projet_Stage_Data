# Plan: 611 — Source Company Plugin: Typeface
...
Typeface's careers board is hosted on Greenhouse at the slug
`typeface`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-typeface` plugin.
- Deliverables: package files, `Site.TYPEFACE` enum value, the
...
- `packages/plugins/source-company-typeface` (new)
