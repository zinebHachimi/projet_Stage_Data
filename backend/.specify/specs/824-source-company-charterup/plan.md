# Plan: 824 — Source Company Plugin: CharterUP
...
CharterUP's careers board is hosted on Greenhouse at the slug
`charterup`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-charterup` plugin.
- Deliverables: package files, `Site.CHARTERUP` enum value, the
...
- `packages/plugins/source-company-charterup` (new)
