# Plan: 493 — Source Company Plugin: Home Chef
...
Home Chef's careers board is hosted on Greenhouse at the slug
`homechef`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-homechef` plugin.
- Deliverables: package files, `Site.HOMECHEF` enum value, the
...
- `packages/plugins/source-company-homechef` (new)
