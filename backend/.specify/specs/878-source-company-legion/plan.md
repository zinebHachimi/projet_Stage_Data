# Plan: 878 — Source Company Plugin: Legion Technologies
...
Legion Technologies's careers board is hosted on Greenhouse at the slug
`legion`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-legion` plugin.
- Deliverables: package files, `Site.LEGION_TECHNOLOGIES` enum value, the
...
- `packages/plugins/source-company-legion` (new)
