# Plan: 479 — Source Company Plugin: Galileo
...
Galileo's careers board is hosted on Greenhouse at the slug
`galileo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-galileo` plugin.
- Deliverables: package files, `Site.GALILEO` enum value, the
...
- `packages/plugins/source-company-galileo` (new)
