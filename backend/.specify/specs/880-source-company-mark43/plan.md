# Plan: 880 — Source Company Plugin: Mark43
...
Mark43's careers board is hosted on Greenhouse at the slug
`mark43`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mark43` plugin.
- Deliverables: package files, `Site.MARK43` enum value, the
...
- `packages/plugins/source-company-mark43` (new)
