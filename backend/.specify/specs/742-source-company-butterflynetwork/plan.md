# Plan: 742 — Source Company Plugin: Butterfly Network
...
Butterfly Network's careers board is hosted on Greenhouse at the slug
`butterflynetwork`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-butterflynetwork` plugin.
- Deliverables: package files, `Site.BUTTERFLY_NETWORK` enum value, the
...
- `packages/plugins/source-company-butterflynetwork` (new)
