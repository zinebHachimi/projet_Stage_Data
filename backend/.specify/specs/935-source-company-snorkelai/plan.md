# Plan: 935 — Source Company Plugin: Snorkel AI
...
Snorkel AI's careers board is hosted on Greenhouse at the slug
`snorkelai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-snorkelai` plugin.
- Deliverables: package files, `Site.SNORKEL_AI` enum value, the
...
- `packages/plugins/source-company-snorkelai` (new)
