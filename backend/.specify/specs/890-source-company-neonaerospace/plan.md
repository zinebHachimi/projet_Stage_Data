# Plan: 890 — Source Company Plugin: Neon Aerospace
...
Neon Aerospace's careers board is hosted on Greenhouse at the slug
`neonaerospace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-neonaerospace` plugin.
- Deliverables: package files, `Site.NEON_AEROSPACE` enum value, the
...
- `packages/plugins/source-company-neonaerospace` (new)
