# Plan: 279 — Source Company Plugin: Apera AI Inc
...
Apera AI Inc's careers board is hosted on Greenhouse at the slug
`aperaaiinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aperaaiinc` plugin.
- Deliverables: package files, `Site.APERAAIINC` enum value, the
...
- `packages/plugins/source-company-aperaaiinc` (new)
