# Plan: 844 — Source Company Plugin: Exiger
...
Exiger's careers board is hosted on Greenhouse at the slug
`exiger`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-exiger` plugin.
- Deliverables: package files, `Site.EXIGER` enum value, the
...
- `packages/plugins/source-company-exiger` (new)
