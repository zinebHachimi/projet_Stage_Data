# Plan: 712 — Source Company Plugin: Prove
...
Prove's careers board is hosted on Greenhouse at the slug
`prove`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-prove` plugin.
- Deliverables: package files, `Site.PROVE` enum value, the
...
- `packages/plugins/source-company-prove` (new)
