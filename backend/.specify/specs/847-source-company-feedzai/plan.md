# Plan: 847 — Source Company Plugin: Feedzai
...
Feedzai's careers board is hosted on Greenhouse at the slug
`feedzai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-feedzai` plugin.
- Deliverables: package files, `Site.FEEDZAI` enum value, the
...
- `packages/plugins/source-company-feedzai` (new)
