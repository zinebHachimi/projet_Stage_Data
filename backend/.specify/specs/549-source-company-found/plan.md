# Plan: 549 — Source Company Plugin: Found
...
Found's careers board is hosted on Greenhouse at the slug
`found`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-found` plugin.
- Deliverables: package files, `Site.FOUND` enum value, the
...
- `packages/plugins/source-company-found` (new)
