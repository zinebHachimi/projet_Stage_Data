# Plan: 811 — Source Company Plugin: Augury
...
Augury's careers board is hosted on Greenhouse at the slug
`augury`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-augury` plugin.
- Deliverables: package files, `Site.AUGURY` enum value, the
...
- `packages/plugins/source-company-augury` (new)
