# Plan: 630 — Source Company Plugin: Rocket Lab
...
Rocket Lab's careers board is hosted on Greenhouse at the slug
`rocketlab`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-rocketlab` plugin.
- Deliverables: package files, `Site.ROCKET_LAB` enum value, the
...
- `packages/plugins/source-company-rocketlab` (new)
