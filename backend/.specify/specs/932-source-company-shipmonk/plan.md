# Plan: 932 — Source Company Plugin: ShipMonk
...
ShipMonk's careers board is hosted on Greenhouse at the slug
`shipmonk`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-shipmonk` plugin.
- Deliverables: package files, `Site.SHIPMONK` enum value, the
...
- `packages/plugins/source-company-shipmonk` (new)
