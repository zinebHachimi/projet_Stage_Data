# Plan: 199 — Source Company Plugin: AE Studio
...
AE Studio's careers board is hosted on Greenhouse at the slug
`aestudio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aestudio` plugin.
- Deliverables: package files, `Site.AESTUDIO` enum value, the
...
- `packages/plugins/source-company-aestudio` (new)
