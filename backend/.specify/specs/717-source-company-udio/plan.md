# Plan: 717 — Source Company Plugin: Udio
...
Udio's careers board is hosted on Greenhouse at the slug
`udio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-udio` plugin.
- Deliverables: package files, `Site.UDIO` enum value, the
...
- `packages/plugins/source-company-udio` (new)
