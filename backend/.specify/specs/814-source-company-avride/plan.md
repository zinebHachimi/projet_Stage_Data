# Plan: 814 — Source Company Plugin: Avride
...
Avride's careers board is hosted on Greenhouse at the slug
`avride`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-avride` plugin.
- Deliverables: package files, `Site.AVRIDE` enum value, the
...
- `packages/plugins/source-company-avride` (new)
