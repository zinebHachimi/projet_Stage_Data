# Plan: 693 — Source Company Plugin: SumUp
...
SumUp's careers board is hosted on Greenhouse at the slug
`sumup`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sumup` plugin.
- Deliverables: package files, `Site.SUMUP` enum value, the
...
- `packages/plugins/source-company-sumup` (new)
