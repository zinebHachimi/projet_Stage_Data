# Plan: 454 — Source Company Plugin: Builder.io
...
Builder.io's careers board is hosted on Greenhouse at the slug
`builder`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-builder` plugin.
- Deliverables: package files, `Site.BUILDER` enum value, the
...
- `packages/plugins/source-company-builder` (new)
