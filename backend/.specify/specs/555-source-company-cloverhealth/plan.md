# Plan: 555 — Source Company Plugin: Clover Health
...
Clover Health's careers board is hosted on Greenhouse at the slug
`cloverhealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cloverhealth` plugin.
- Deliverables: package files, `Site.CLOVER_HEALTH` enum value, the
...
- `packages/plugins/source-company-cloverhealth` (new)
