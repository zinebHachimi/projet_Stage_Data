# Plan: 760 — Source Company Plugin: Elation Health
...
Elation Health's careers board is hosted on Greenhouse at the slug
`elationhealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-elationhealth` plugin.
- Deliverables: package files, `Site.ELATION_HEALTH` enum value, the
...
- `packages/plugins/source-company-elationhealth` (new)
