# Plan: 568 — Source Company Plugin: Formation Bio
...
Formation Bio's careers board is hosted on Greenhouse at the slug
`formationbio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-formationbio` plugin.
- Deliverables: package files, `Site.FORMATION_BIO` enum value, the
...
- `packages/plugins/source-company-formationbio` (new)
