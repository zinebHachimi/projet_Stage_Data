# Plan: 194 — Source Company Plugin: Advocate Construction
...
Advocate Construction's careers board is hosted on Greenhouse at the slug
`advocateconstruction`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-advocateconstruction` plugin.
- Deliverables: package files, `Site.ADVOCATECONSTRUCTION` enum value, the
...
- `packages/plugins/source-company-advocateconstruction` (new)
