# Plan: 434 — Source Company Plugin: Nextdoor
...
Nextdoor's careers board is hosted on Greenhouse at the slug
`nextdoor`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nextdoor` plugin.
- Deliverables: package files, `Site.NEXTDOOR` enum value, the
...
- `packages/plugins/source-company-nextdoor` (new)
