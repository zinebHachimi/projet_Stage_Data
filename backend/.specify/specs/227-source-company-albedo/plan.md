# Plan: 227 — Source Company Plugin: Albedo
...
Albedo's careers board is hosted on Greenhouse at the slug
`albedo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-albedo` plugin.
- Deliverables: package files, `Site.ALBEDO` enum value, the
...
- `packages/plugins/source-company-albedo` (new)
