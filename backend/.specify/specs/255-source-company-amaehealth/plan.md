# Plan: 255 — Source Company Plugin: Amae Health
...
Amae Health's careers board is hosted on Greenhouse at the slug
`amaehealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amaehealth` plugin.
- Deliverables: package files, `Site.AMAEHEALTH` enum value, the
...
- `packages/plugins/source-company-amaehealth` (new)
