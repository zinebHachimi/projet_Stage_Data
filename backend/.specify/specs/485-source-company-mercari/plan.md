# Plan: 485 — Source Company Plugin: Mercari
...
Mercari's careers board is hosted on Greenhouse at the slug
`mercari`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mercari` plugin.
- Deliverables: package files, `Site.MERCARI` enum value, the
...
- `packages/plugins/source-company-mercari` (new)
