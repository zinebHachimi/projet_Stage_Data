# Plan: 432 — Source Company Plugin: Cockroach Labs
...
Cockroach Labs's careers board is hosted on Greenhouse at the slug
`cockroachlabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cockroachlabs` plugin.
- Deliverables: package files, `Site.COCKROACHLABS` enum value, the
...
- `packages/plugins/source-company-cockroachlabs` (new)
