# Plan: 950 — Source Company Plugin: Tenable
...
Tenable's careers board is hosted on Greenhouse at the slug
`tenableinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tenableinc` plugin.
- Deliverables: package files, `Site.TENABLE` enum value, the
...
- `packages/plugins/source-company-tenableinc` (new)
