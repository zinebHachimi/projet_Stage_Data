# Plan: 759 — Source Company Plugin: BlackSky Technology
...
BlackSky Technology's careers board is hosted on Greenhouse at the slug
`blacksky`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-blacksky` plugin.
- Deliverables: package files, `Site.BLACKSKY_TECHNOLOGY` enum value, the
...
- `packages/plugins/source-company-blacksky` (new)
