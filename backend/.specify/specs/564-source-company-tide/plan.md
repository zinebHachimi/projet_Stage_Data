# Plan: 564 — Source Company Plugin: Tide
...
Tide's careers board is hosted on Greenhouse at the slug
`tide`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tide` plugin.
- Deliverables: package files, `Site.TIDE` enum value, the
...
- `packages/plugins/source-company-tide` (new)
