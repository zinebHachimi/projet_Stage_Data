# Plan: 281 — Source Company Plugin: Apex Companies
...
Apex Companies's careers board is hosted on Greenhouse at the slug
`apexcompanies`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apexcompanies` plugin.
- Deliverables: package files, `Site.APEXCOMPANIES` enum value, the
...
- `packages/plugins/source-company-apexcompanies` (new)
