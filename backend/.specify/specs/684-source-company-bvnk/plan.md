# Plan: 684 — Source Company Plugin: BVNK
...
BVNK's careers board is hosted on Greenhouse at the slug
`bvnk`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-bvnk` plugin.
- Deliverables: package files, `Site.BVNK` enum value, the
...
- `packages/plugins/source-company-bvnk` (new)
