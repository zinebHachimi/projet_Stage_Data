# Plan: 793 — Source Company Plugin: FastSpring
...
FastSpring's careers board is hosted on Greenhouse at the slug
`fastspring`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fastspring` plugin.
- Deliverables: package files, `Site.FASTSPRING` enum value, the
...
- `packages/plugins/source-company-fastspring` (new)
