# Plan: 691 — Source Company Plugin: Profluent
...
Profluent's careers board is hosted on Greenhouse at the slug
`profluent`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-profluent` plugin.
- Deliverables: package files, `Site.PROFLUENT` enum value, the
...
- `packages/plugins/source-company-profluent` (new)
