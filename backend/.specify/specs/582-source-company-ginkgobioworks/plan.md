# Plan: 582 — Source Company Plugin: Ginkgo Bioworks
...
Ginkgo Bioworks's careers board is hosted on Greenhouse at the slug
`ginkgobioworks`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ginkgobioworks` plugin.
- Deliverables: package files, `Site.GINKGO_BIOWORKS` enum value, the
...
- `packages/plugins/source-company-ginkgobioworks` (new)
