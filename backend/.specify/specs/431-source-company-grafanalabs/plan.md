# Plan: 431 — Source Company Plugin: Grafana Labs
...
Grafana Labs's careers board is hosted on Greenhouse at the slug
`grafanalabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-grafanalabs` plugin.
- Deliverables: package files, `Site.GRAFANALABS` enum value, the
...
- `packages/plugins/source-company-grafanalabs` (new)
