# Plan: 453 — Source Company Plugin: Salesloft
...
Salesloft's careers board is hosted on Greenhouse at the slug
`salesloft`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-salesloft` plugin.
- Deliverables: package files, `Site.SALESLOFT` enum value, the
...
- `packages/plugins/source-company-salesloft` (new)
