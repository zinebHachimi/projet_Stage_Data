# Plan: 214 — Source Company Plugin: Airia
...
Airia's careers board is hosted on Greenhouse at the slug
`airia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-airia` plugin.
- Deliverables: package files, `Site.AIRIA` enum value, the
...
- `packages/plugins/source-company-airia` (new)
