# Plan: 966 — Source Company Plugin: Viant Technology
...
Viant Technology's careers board is hosted on Greenhouse at the slug
`vianttechnology`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-vianttechnology` plugin.
- Deliverables: package files, `Site.VIANT_TECHNOLOGY` enum value, the
...
- `packages/plugins/source-company-vianttechnology` (new)
