# Plan: 747 — Source Company Plugin: Locus Robotics
...
Locus Robotics's careers board is hosted on Greenhouse at the slug
`locusrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-locusrobotics` plugin.
- Deliverables: package files, `Site.LOCUS_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-locusrobotics` (new)
