# Plan: 245 — Source Company Plugin: Alt
...
Alt's careers board is hosted on Greenhouse at the slug
`alt`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alt` plugin.
- Deliverables: package files, `Site.ALT` enum value, the
...
- `packages/plugins/source-company-alt` (new)
