# Plan: 770 — Source Company Plugin: Suki AI
...
Suki AI's careers board is hosted on Greenhouse at the slug
`suki`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-suki` plugin.
- Deliverables: package files, `Site.SUKI_AI` enum value, the
...
- `packages/plugins/source-company-suki` (new)
