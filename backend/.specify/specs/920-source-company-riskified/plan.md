# Plan: 920 — Source Company Plugin: Riskified
...
Riskified's careers board is hosted on Greenhouse at the slug
`riskified`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-riskified` plugin.
- Deliverables: package files, `Site.RISKIFIED` enum value, the
...
- `packages/plugins/source-company-riskified` (new)
