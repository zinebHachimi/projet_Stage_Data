# Plan: 870 — Source Company Plugin: Instawork
...
Instawork's careers board is hosted on Greenhouse at the slug
`instawork`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-instawork` plugin.
- Deliverables: package files, `Site.INSTAWORK` enum value, the
...
- `packages/plugins/source-company-instawork` (new)
