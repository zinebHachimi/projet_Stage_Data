# Plan: 505 — Source Company Plugin: Nayya
...
Nayya's careers board is hosted on Greenhouse at the slug
`nayya`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nayya` plugin.
- Deliverables: package files, `Site.NAYYA` enum value, the
...
- `packages/plugins/source-company-nayya` (new)
