# Plan: 766 — Source Company Plugin: Ophelia Health
...
Ophelia Health's careers board is hosted on Greenhouse at the slug
`ophelia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ophelia` plugin.
- Deliverables: package files, `Site.OPHELIA_HEALTH` enum value, the
...
- `packages/plugins/source-company-ophelia` (new)
