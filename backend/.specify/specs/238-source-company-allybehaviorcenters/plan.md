# Plan: 238 — Source Company Plugin: Ally Behavior Centers
...
Ally Behavior Centers's careers board is hosted on Greenhouse at the slug
`allybehaviorcenters`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-allybehaviorcenters` plugin.
- Deliverables: package files, `Site.ALLYBEHAVIORCENTERS` enum value, the
...
- `packages/plugins/source-company-allybehaviorcenters` (new)
