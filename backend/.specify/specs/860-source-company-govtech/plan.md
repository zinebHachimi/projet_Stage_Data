# Plan: 860 — Source Company Plugin: GovTech Singapore (Government Technology Agency)
...
GovTech Singapore (Government Technology Agency)'s careers board is hosted on Greenhouse at the slug
`govtech`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-govtech` plugin.
- Deliverables: package files, `Site.GOVTECH_SINGAPORE_GOVERNMENT_TECHNOLOGY_AGENCY` enum value, the
...
- `packages/plugins/source-company-govtech` (new)
