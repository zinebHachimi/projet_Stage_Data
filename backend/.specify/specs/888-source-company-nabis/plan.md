# Plan: 888 — Source Company Plugin: Nabis
...
Nabis's careers board is hosted on Greenhouse at the slug
`nabis`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nabis` plugin.
- Deliverables: package files, `Site.NABIS` enum value, the
...
- `packages/plugins/source-company-nabis` (new)
