# Plan: 746 — Source Company Plugin: Khan Academy
...
Khan Academy's careers board is hosted on Greenhouse at the slug
`khanacademy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-khanacademy` plugin.
- Deliverables: package files, `Site.KHAN_ACADEMY` enum value, the
...
- `packages/plugins/source-company-khanacademy` (new)
