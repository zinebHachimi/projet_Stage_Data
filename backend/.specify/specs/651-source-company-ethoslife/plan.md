# Plan: 651 — Source Company Plugin: Ethos Life
...
Ethos Life's careers board is hosted on Greenhouse at the slug
`ethoslife`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ethoslife` plugin.
- Deliverables: package files, `Site.ETHOS_LIFE` enum value, the
...
- `packages/plugins/source-company-ethoslife` (new)
