# Plan: 427 — Source Company Plugin: Gemini
...
Gemini's careers board is hosted on Greenhouse at the slug
`gemini`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gemini` plugin.
- Deliverables: package files, `Site.GEMINI` enum value, the
...
- `packages/plugins/source-company-gemini` (new)
