# Plan: 240 — Source Company Plugin: Alpha FMC - UK 
...
Alpha FMC - UK 's careers board is hosted on Greenhouse at the slug
`alphafmc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alphafmc` plugin.
- Deliverables: package files, `Site.ALPHAFMC` enum value, the
...
- `packages/plugins/source-company-alphafmc` (new)
