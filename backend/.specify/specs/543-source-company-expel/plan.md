# Plan: 543 — Source Company Plugin: Expel
...
Expel's careers board is hosted on Greenhouse at the slug
`expel`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-expel` plugin.
- Deliverables: package files, `Site.EXPEL` enum value, the
...
- `packages/plugins/source-company-expel` (new)
