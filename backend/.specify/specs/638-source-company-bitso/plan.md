# Plan: 638 — Source Company Plugin: Bitso
...
Bitso's careers board is hosted on Greenhouse at the slug
`bitso`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-bitso` plugin.
- Deliverables: package files, `Site.BITSO` enum value, the
...
- `packages/plugins/source-company-bitso` (new)
