# Plan: 259 — Source Company Plugin: AMEND Consulting
...
AMEND Consulting's careers board is hosted on Greenhouse at the slug
`amendconsulting`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amendconsulting` plugin.
- Deliverables: package files, `Site.AMENDCONSULTING` enum value, the
...
- `packages/plugins/source-company-amendconsulting` (new)
