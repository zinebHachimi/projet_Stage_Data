# Plan: 560 — Source Company Plugin: Modern Animal
...
Modern Animal's careers board is hosted on Greenhouse at the slug
`modernanimal`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-modernanimal` plugin.
- Deliverables: package files, `Site.MODERN_ANIMAL` enum value, the
...
- `packages/plugins/source-company-modernanimal` (new)
