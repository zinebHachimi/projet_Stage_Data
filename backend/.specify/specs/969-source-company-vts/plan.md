# Plan: 969 — Source Company Plugin: VTS
...
VTS's careers board is hosted on Greenhouse at the slug
`vts`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-vts` plugin.
- Deliverables: package files, `Site.VTS` enum value, the
...
- `packages/plugins/source-company-vts` (new)
