# Plan: 768 — Source Company Plugin: Qventus
...
Qventus's careers board is hosted on Greenhouse at the slug
`qventus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-qventus` plugin.
- Deliverables: package files, `Site.QVENTUS` enum value, the
...
- `packages/plugins/source-company-qventus` (new)
