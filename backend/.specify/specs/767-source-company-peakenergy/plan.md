# Plan: 767 — Source Company Plugin: Peak Energy
...
Peak Energy's careers board is hosted on Greenhouse at the slug
`peakenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-peakenergy` plugin.
- Deliverables: package files, `Site.PEAK_ENERGY` enum value, the
...
- `packages/plugins/source-company-peakenergy` (new)
