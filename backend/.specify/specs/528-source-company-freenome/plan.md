# Plan: 528 — Source Company Plugin: Freenome
...
Freenome's careers board is hosted on Greenhouse at the slug
`freenome`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-freenome` plugin.
- Deliverables: package files, `Site.FREENOME` enum value, the
...
- `packages/plugins/source-company-freenome` (new)
