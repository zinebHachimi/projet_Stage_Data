# Plan: 971 — Source Company Plugin: Wiz
...
Wiz's careers board is hosted on Greenhouse at the slug
`wizinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-wizinc` plugin.
- Deliverables: package files, `Site.WIZ` enum value, the
...
- `packages/plugins/source-company-wizinc` (new)
