# Plan: 266 — Source Company Plugin: Amylyx Pharmaceuticals
...
Amylyx Pharmaceuticals's careers board is hosted on Greenhouse at the slug
`amylyx`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amylyx` plugin.
- Deliverables: package files, `Site.AMYLYX` enum value, the
...
- `packages/plugins/source-company-amylyx` (new)
