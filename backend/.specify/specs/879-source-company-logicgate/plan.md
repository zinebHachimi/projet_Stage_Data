# Plan: 879 — Source Company Plugin: LogicGate
...
LogicGate's careers board is hosted on Greenhouse at the slug
`logicgate`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-logicgate` plugin.
- Deliverables: package files, `Site.LOGICGATE` enum value, the
...
- `packages/plugins/source-company-logicgate` (new)
