# Plan: 654 — Source Company Plugin: Insurify
...
Insurify's careers board is hosted on Greenhouse at the slug
`insurify`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-insurify` plugin.
- Deliverables: package files, `Site.INSURIFY` enum value, the
...
- `packages/plugins/source-company-insurify` (new)
