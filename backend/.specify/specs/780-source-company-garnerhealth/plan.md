# Plan: 780 — Source Company Plugin: Garner Health
...
Garner Health's careers board is hosted on Greenhouse at the slug
`garnerhealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-garnerhealth` plugin.
- Deliverables: package files, `Site.GARNER_HEALTH` enum value, the
...
- `packages/plugins/source-company-garnerhealth` (new)
