# Plan: 596 — Source Company Plugin: Quince
...
Quince's careers board is hosted on Greenhouse at the slug
`quince`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-quince` plugin.
- Deliverables: package files, `Site.QUINCE` enum value, the
...
- `packages/plugins/source-company-quince` (new)
