# Plan: 481 — Source Company Plugin: Stability AI
...
Stability AI's careers board is hosted on Greenhouse at the slug
`stabilityai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-stabilityai` plugin.
- Deliverables: package files, `Site.STABILITYAI` enum value, the
...
- `packages/plugins/source-company-stabilityai` (new)
