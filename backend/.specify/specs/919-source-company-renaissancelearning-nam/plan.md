# Plan: 919 — Source Company Plugin: Renaissance Learning
...
Renaissance Learning's careers board is hosted on Greenhouse at the slug
`renaissancelearning-nam`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-renaissancelearning-nam` plugin.
- Deliverables: package files, `Site.RENAISSANCE_LEARNING` enum value, the
...
- `packages/plugins/source-company-renaissancelearning-nam` (new)
