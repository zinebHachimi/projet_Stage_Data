# Plan: 854 — Source Company Plugin: Galvanize Climate Solutions
...
Galvanize Climate Solutions's careers board is hosted on Greenhouse at the slug
`galvanizeclimatesolutions`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-galvanizeclimatesolutions` plugin.
- Deliverables: package files, `Site.GALVANIZE_CLIMATE_SOLUTIONS` enum value, the
...
- `packages/plugins/source-company-galvanizeclimatesolutions` (new)
