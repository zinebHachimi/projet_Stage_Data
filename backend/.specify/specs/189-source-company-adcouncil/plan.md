# Plan: 189 — Source Company Plugin: the Ad Council
...
the Ad Council's careers board is hosted on Greenhouse at the slug
`adcouncil`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-adcouncil` plugin.
- Deliverables: package files, `Site.ADCOUNCIL` enum value, the
...
- `packages/plugins/source-company-adcouncil` (new)
