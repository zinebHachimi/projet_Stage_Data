# Plan: 471 — Source Company Plugin: Merge
...
Merge's careers board is hosted on Greenhouse at the slug
`merge`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-merge` plugin.
- Deliverables: package files, `Site.MERGE` enum value, the
...
- `packages/plugins/source-company-merge` (new)
