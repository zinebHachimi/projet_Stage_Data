# Plan: 761 — Source Company Plugin: Flatiron Health
...
Flatiron Health's careers board is hosted on Greenhouse at the slug
`flatironhealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-flatironhealth` plugin.
- Deliverables: package files, `Site.FLATIRON_HEALTH` enum value, the
...
- `packages/plugins/source-company-flatironhealth` (new)
