# Plan: 506 — Source Company Plugin: Caribou Financial
...
Caribou Financial's careers board is hosted on Greenhouse at the slug
`caribou`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-caribou` plugin.
- Deliverables: package files, `Site.CARIBOU` enum value, the
...
- `packages/plugins/source-company-caribou` (new)
