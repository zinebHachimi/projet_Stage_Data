# Plan: 559 — Source Company Plugin: Wayve
...
Wayve's careers board is hosted on Greenhouse at the slug
`wayve`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-wayve` plugin.
- Deliverables: package files, `Site.WAYVE` enum value, the
...
- `packages/plugins/source-company-wayve` (new)
