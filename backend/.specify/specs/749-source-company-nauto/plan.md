# Plan: 749 — Source Company Plugin: Nauto
...
Nauto's careers board is hosted on Greenhouse at the slug
`nauto`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nauto` plugin.
- Deliverables: package files, `Site.NAUTO` enum value, the
...
- `packages/plugins/source-company-nauto` (new)
