# Plan: 283 — Source Company Plugin: Apiiro
...
Apiiro's careers board is hosted on Greenhouse at the slug
`apiiro`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apiiro` plugin.
- Deliverables: package files, `Site.APIIRO` enum value, the
...
- `packages/plugins/source-company-apiiro` (new)
