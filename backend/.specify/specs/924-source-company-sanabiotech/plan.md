# Plan: 924 — Source Company Plugin: Sana Biotechnology
...
Sana Biotechnology's careers board is hosted on Greenhouse at the slug
`sanabiotech`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sanabiotech` plugin.
- Deliverables: package files, `Site.SANA_BIOTECHNOLOGY` enum value, the
...
- `packages/plugins/source-company-sanabiotech` (new)
