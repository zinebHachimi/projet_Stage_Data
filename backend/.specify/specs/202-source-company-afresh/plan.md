# Plan: 202 — Source Company Plugin: Afresh
...
Afresh's careers board is hosted on Greenhouse at the slug
`afresh`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-afresh` plugin.
- Deliverables: package files, `Site.AFRESH` enum value, the
...
- `packages/plugins/source-company-afresh` (new)
