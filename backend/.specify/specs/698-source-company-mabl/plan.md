# Plan: 698 — Source Company Plugin: mabl
...
mabl's careers board is hosted on Greenhouse at the slug
`mabl`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mabl` plugin.
- Deliverables: package files, `Site.MABL` enum value, the
...
- `packages/plugins/source-company-mabl` (new)
