# Plan: 902 — Source Company Plugin: Veo
...
Veo's careers board is hosted on Greenhouse at the slug
`operationscareers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-operationscareers` plugin.
- Deliverables: package files, `Site.VEO` enum value, the
...
- `packages/plugins/source-company-operationscareers` (new)
