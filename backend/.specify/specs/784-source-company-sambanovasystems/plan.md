# Plan: 784 — Source Company Plugin: SambaNova Systems
...
SambaNova Systems's careers board is hosted on Greenhouse at the slug
`sambanovasystems`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sambanovasystems` plugin.
- Deliverables: package files, `Site.SAMBANOVA_SYSTEMS` enum value, the
...
- `packages/plugins/source-company-sambanovasystems` (new)
