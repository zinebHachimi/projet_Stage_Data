# Plan: 526 — Source Company Plugin: Talkspace
...
Talkspace's careers board is hosted on Greenhouse at the slug
`talkspace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-talkspace` plugin.
- Deliverables: package files, `Site.TALKSPACE` enum value, the
...
- `packages/plugins/source-company-talkspace` (new)
