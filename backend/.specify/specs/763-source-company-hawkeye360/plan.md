# Plan: 763 — Source Company Plugin: HawkEye 360
...
HawkEye 360's careers board is hosted on Greenhouse at the slug
`hawkeye360`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hawkeye360` plugin.
- Deliverables: package files, `Site.HAWKEYE_360` enum value, the
...
- `packages/plugins/source-company-hawkeye360` (new)
