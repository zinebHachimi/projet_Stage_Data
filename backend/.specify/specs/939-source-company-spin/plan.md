# Plan: 939 — Source Company Plugin: Spin
...
Spin's careers board is hosted on Greenhouse at the slug
`spin`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-spin` plugin.
- Deliverables: package files, `Site.SPIN` enum value, the
...
- `packages/plugins/source-company-spin` (new)
