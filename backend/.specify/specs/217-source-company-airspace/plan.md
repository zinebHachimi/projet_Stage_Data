# Plan: 217 — Source Company Plugin: Airspace 
...
Airspace 's careers board is hosted on Greenhouse at the slug
`airspace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-airspace` plugin.
- Deliverables: package files, `Site.AIRSPACE` enum value, the
...
- `packages/plugins/source-company-airspace` (new)
