# Plan: 677 — Source Company Plugin: Nutrafol
...
Nutrafol's careers board is hosted on Greenhouse at the slug
`nutrafol`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nutrafol` plugin.
- Deliverables: package files, `Site.NUTRAFOL` enum value, the
...
- `packages/plugins/source-company-nutrafol` (new)
