# Plan: 972 — Source Company Plugin: Wurl
...
Wurl's careers board is hosted on Greenhouse at the slug
`wurljobs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-wurljobs` plugin.
- Deliverables: package files, `Site.WURL` enum value, the
...
- `packages/plugins/source-company-wurljobs` (new)
