# Plan: 221 — Source Company Plugin: Akido
...
Akido's careers board is hosted on Greenhouse at the slug
`akidolabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-akidolabs` plugin.
- Deliverables: package files, `Site.AKIDOLABS` enum value, the
...
- `packages/plugins/source-company-akidolabs` (new)
