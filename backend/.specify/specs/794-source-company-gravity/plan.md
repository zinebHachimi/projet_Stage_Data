# Plan: 794 — Source Company Plugin: Gravity R&D
...
Gravity R&D's careers board is hosted on Greenhouse at the slug
`gravity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gravity` plugin.
- Deliverables: package files, `Site.GRAVITY_R_D` enum value, the
...
- `packages/plugins/source-company-gravity` (new)
