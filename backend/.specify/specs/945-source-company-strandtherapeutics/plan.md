# Plan: 945 — Source Company Plugin: Strand Therapeutics
...
Strand Therapeutics's careers board is hosted on Greenhouse at the slug
`strandtherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-strandtherapeutics` plugin.
- Deliverables: package files, `Site.STRAND_THERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-strandtherapeutics` (new)
