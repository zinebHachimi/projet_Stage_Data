# Plan: 261 — Source Company Plugin: American Institute
...
American Institute's careers board is hosted on Greenhouse at the slug
`americaninstitute`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-americaninstitute` plugin.
- Deliverables: package files, `Site.AMERICANINSTITUTE` enum value, the
...
- `packages/plugins/source-company-americaninstitute` (new)
