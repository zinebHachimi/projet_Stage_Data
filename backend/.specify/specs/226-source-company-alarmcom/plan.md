# Plan: 226 — Source Company Plugin: Alarm.com
...
Alarm.com's careers board is hosted on Greenhouse at the slug
`alarmcom`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alarmcom` plugin.
- Deliverables: package files, `Site.ALARMCOM` enum value, the
...
- `packages/plugins/source-company-alarmcom` (new)
