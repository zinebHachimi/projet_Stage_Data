# Plan: 292 — Source Company Plugin: Appian Corporation 
...
Appian Corporation 's careers board is hosted on Greenhouse at the slug
`appian`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-appian` plugin.
- Deliverables: package files, `Site.APPIAN` enum value, the
...
- `packages/plugins/source-company-appian` (new)
