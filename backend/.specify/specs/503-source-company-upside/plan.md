# Plan: 503 — Source Company Plugin: Upside
...
Upside's careers board is hosted on Greenhouse at the slug
`upside`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-upside` plugin.
- Deliverables: package files, `Site.UPSIDE` enum value, the
...
- `packages/plugins/source-company-upside` (new)
