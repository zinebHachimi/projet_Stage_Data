# Plan: 864 — Source Company Plugin: Homeward
...
Homeward's careers board is hosted on Greenhouse at the slug
`homeward`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-homeward` plugin.
- Deliverables: package files, `Site.HOMEWARD` enum value, the
...
- `packages/plugins/source-company-homeward` (new)
