# Plan: 618 — Source Company Plugin: LetsGetChecked
...
LetsGetChecked's careers board is hosted on Greenhouse at the slug
`letsgetchecked`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-letsgetchecked` plugin.
- Deliverables: package files, `Site.LETSGETCHECKED` enum value, the
...
- `packages/plugins/source-company-letsgetchecked` (new)
