# Plan: 631 — Source Company Plugin: Seurat Technologies
...
Seurat Technologies's careers board is hosted on Greenhouse at the slug
`seurat`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-seurat` plugin.
- Deliverables: package files, `Site.SEURAT_TECHNOLOGIES` enum value, the
...
- `packages/plugins/source-company-seurat` (new)
