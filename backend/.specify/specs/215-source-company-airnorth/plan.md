# Plan: 215 — Source Company Plugin: Air North
...
Air North's careers board is hosted on Greenhouse at the slug
`airnorth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-airnorth` plugin.
- Deliverables: package files, `Site.AIRNORTH` enum value, the
...
- `packages/plugins/source-company-airnorth` (new)
