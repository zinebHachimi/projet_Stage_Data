# Plan: 771 — Source Company Plugin: Twist Bioscience
...
Twist Bioscience's careers board is hosted on Greenhouse at the slug
`twistbioscience`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-twistbioscience` plugin.
- Deliverables: package files, `Site.TWIST_BIOSCIENCE` enum value, the
...
- `packages/plugins/source-company-twistbioscience` (new)
