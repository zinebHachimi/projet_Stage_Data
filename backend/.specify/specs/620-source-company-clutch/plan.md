# Plan: 620 — Source Company Plugin: Clutch
...
Clutch's careers board is hosted on Greenhouse at the slug
`clutch`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-clutch` plugin.
- Deliverables: package files, `Site.CLUTCH` enum value, the
...
- `packages/plugins/source-company-clutch` (new)
