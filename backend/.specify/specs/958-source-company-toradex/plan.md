# Plan: 958 — Source Company Plugin: Toradex
...
Toradex's careers board is hosted on Greenhouse at the slug
`toradex`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-toradex` plugin.
- Deliverables: package files, `Site.TORADEX` enum value, the
...
- `packages/plugins/source-company-toradex` (new)
