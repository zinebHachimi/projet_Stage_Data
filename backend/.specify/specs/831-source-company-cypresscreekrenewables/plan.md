# Plan: 831 — Source Company Plugin: Cypress Creek Renewables
...
Cypress Creek Renewables's careers board is hosted on Greenhouse at the slug
`cypresscreekrenewables`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cypresscreekrenewables` plugin.
- Deliverables: package files, `Site.CYPRESS_CREEK_RENEWABLES` enum value, the
...
- `packages/plugins/source-company-cypresscreekrenewables` (new)
