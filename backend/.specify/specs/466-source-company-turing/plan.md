# Plan: 466 — Source Company Plugin: Turing
...
Turing's careers board is hosted on Greenhouse at the slug
`turing`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-turing` plugin.
- Deliverables: package files, `Site.TURING` enum value, the
...
- `packages/plugins/source-company-turing` (new)
