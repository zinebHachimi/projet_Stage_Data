# Plan: 511 — Source Company Plugin: TrueLayer
...
TrueLayer's careers board is hosted on Greenhouse at the slug
`truelayer`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-truelayer` plugin.
- Deliverables: package files, `Site.TRUELAYER` enum value, the
...
- `packages/plugins/source-company-truelayer` (new)
