# Plan: 627 — Source Company Plugin: Isomorphic Labs
...
Isomorphic Labs's careers board is hosted on Greenhouse at the slug
`isomorphiclabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-isomorphiclabs` plugin.
- Deliverables: package files, `Site.ISOMORPHIC_LABS` enum value, the
...
- `packages/plugins/source-company-isomorphiclabs` (new)
