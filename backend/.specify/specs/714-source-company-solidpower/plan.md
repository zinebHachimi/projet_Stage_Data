# Plan: 714 — Source Company Plugin: Solid Power
...
Solid Power's careers board is hosted on Greenhouse at the slug
`solidpower`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-solidpower` plugin.
- Deliverables: package files, `Site.SOLID_POWER` enum value, the
...
- `packages/plugins/source-company-solidpower` (new)
