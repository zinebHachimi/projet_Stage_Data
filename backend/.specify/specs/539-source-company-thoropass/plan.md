# Plan: 539 — Source Company Plugin: Thoropass
...
Thoropass's careers board is hosted on Greenhouse at the slug
`thoropass`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thoropass` plugin.
- Deliverables: package files, `Site.THOROPASS` enum value, the
...
- `packages/plugins/source-company-thoropass` (new)
