# Plan: 662 — Source Company Plugin: Silicon Ranch
...
Silicon Ranch's careers board is hosted on Greenhouse at the slug
`siliconranch`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-siliconranch` plugin.
- Deliverables: package files, `Site.SILICON_RANCH` enum value, the
...
- `packages/plugins/source-company-siliconranch` (new)
