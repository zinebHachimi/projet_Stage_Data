# Plan: 288 — Source Company Plugin: Apollo.io
...
Apollo.io's careers board is hosted on Greenhouse at the slug
`apolloio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apolloio` plugin.
- Deliverables: package files, `Site.APOLLOIO` enum value, the
...
- `packages/plugins/source-company-apolloio` (new)
