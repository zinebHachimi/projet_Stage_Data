# Plan: 463 — Source Company Plugin: Epirus
...
Epirus's careers board is hosted on Greenhouse at the slug
`epirus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-epirus` plugin.
- Deliverables: package files, `Site.EPIRUS` enum value, the
...
- `packages/plugins/source-company-epirus` (new)
