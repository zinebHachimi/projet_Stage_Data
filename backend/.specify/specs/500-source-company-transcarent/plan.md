# Plan: 500 — Source Company Plugin: Transcarent
...
Transcarent's careers board is hosted on Greenhouse at the slug
`transcarent`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-transcarent` plugin.
- Deliverables: package files, `Site.TRANSCARENT` enum value, the
...
- `packages/plugins/source-company-transcarent` (new)
