# Plan: 433 — Source Company Plugin: Verkada
...
Verkada's careers board is hosted on Greenhouse at the slug
`verkada`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-verkada` plugin.
- Deliverables: package files, `Site.VERKADA` enum value, the
...
- `packages/plugins/source-company-verkada` (new)
