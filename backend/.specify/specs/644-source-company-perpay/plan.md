# Plan: 644 — Source Company Plugin: Perpay
...
Perpay's careers board is hosted on Greenhouse at the slug
`perpay`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-perpay` plugin.
- Deliverables: package files, `Site.PERPAY` enum value, the
...
- `packages/plugins/source-company-perpay` (new)
