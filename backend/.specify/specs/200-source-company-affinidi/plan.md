# Plan: 200 — Source Company Plugin: Affinidi
...
Affinidi's careers board is hosted on Greenhouse at the slug
`affinidi`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-affinidi` plugin.
- Deliverables: package files, `Site.AFFINIDI` enum value, the
...
- `packages/plugins/source-company-affinidi` (new)
