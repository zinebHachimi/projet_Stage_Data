# Plan: 850 — Source Company Plugin: Fleetio
...
Fleetio's careers board is hosted on Greenhouse at the slug
`fleetio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fleetio` plugin.
- Deliverables: package files, `Site.FLEETIO` enum value, the
...
- `packages/plugins/source-company-fleetio` (new)
