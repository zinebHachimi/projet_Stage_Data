# Plan: 894 — Source Company Plugin: Next Insurance
...
Next Insurance's careers board is hosted on Greenhouse at the slug
`nextinsurance66`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nextinsurance66` plugin.
- Deliverables: package files, `Site.NEXT_INSURANCE` enum value, the
...
- `packages/plugins/source-company-nextinsurance66` (new)
