# Plan: 756 — Source Company Plugin: Absci
...
Absci's careers board is hosted on Greenhouse at the slug
`absci`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-absci` plugin.
- Deliverables: package files, `Site.ABSCI` enum value, the
...
- `packages/plugins/source-company-absci` (new)
