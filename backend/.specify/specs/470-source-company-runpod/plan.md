# Plan: 470 — Source Company Plugin: Runpod
...
Runpod's careers board is hosted on Greenhouse at the slug
`runpod`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-runpod` plugin.
- Deliverables: package files, `Site.RUNPOD` enum value, the
...
- `packages/plugins/source-company-runpod` (new)
