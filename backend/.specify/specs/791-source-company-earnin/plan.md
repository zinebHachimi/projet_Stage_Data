# Plan: 791 — Source Company Plugin: EarnIn
...
EarnIn's careers board is hosted on Greenhouse at the slug
`earnin`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-earnin` plugin.
- Deliverables: package files, `Site.EARNIN` enum value, the
...
- `packages/plugins/source-company-earnin` (new)
