# Plan: 260 — Source Company Plugin: American Capital Group
...
American Capital Group's careers board is hosted on Greenhouse at the slug
`americancapitalgroup`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-americancapitalgroup` plugin.
- Deliverables: package files, `Site.AMERICANCAPITALGROUP` enum value, the
...
- `packages/plugins/source-company-americancapitalgroup` (new)
