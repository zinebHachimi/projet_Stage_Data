# Plan: 446 — Source Company Plugin: Riot Games
...
Riot Games's careers board is hosted on Greenhouse at the slug
`riotgames`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-riotgames` plugin.
- Deliverables: package files, `Site.RIOTGAMES` enum value, the
...
- `packages/plugins/source-company-riotgames` (new)
