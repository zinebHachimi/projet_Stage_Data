# Plan: 455 — Source Company Plugin: Storyblok
...
Storyblok's careers board is hosted on Greenhouse at the slug
`storyblok`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-storyblok` plugin.
- Deliverables: package files, `Site.STORYBLOK` enum value, the
...
- `packages/plugins/source-company-storyblok` (new)
