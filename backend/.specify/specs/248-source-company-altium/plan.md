# Plan: 248 — Source Company Plugin: Altium
...
Altium's careers board is hosted on Greenhouse at the slug
`altium`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-altium` plugin.
- Deliverables: package files, `Site.ALTIUM` enum value, the
...
- `packages/plugins/source-company-altium` (new)
