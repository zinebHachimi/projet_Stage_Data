# Plan: 554 — Source Company Plugin: Mill
...
Mill's careers board is hosted on Greenhouse at the slug
`mill`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mill` plugin.
- Deliverables: package files, `Site.MILL` enum value, the
...
- `packages/plugins/source-company-mill` (new)
