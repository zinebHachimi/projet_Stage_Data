# Plan: 241 — Source Company Plugin: Alpha Financial Markets Consulting
...
Alpha Financial Markets Consulting's careers board is hosted on Greenhouse at the slug
`alphafmcroles`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alphafmcroles` plugin.
- Deliverables: package files, `Site.ALPHAFMCROLES` enum value, the
...
- `packages/plugins/source-company-alphafmcroles` (new)
