# Plan: 874 — Source Company Plugin: K2 Space
...
K2 Space's careers board is hosted on Greenhouse at the slug
`k2spacecorporation`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-k2spacecorporation` plugin.
- Deliverables: package files, `Site.K2_SPACE` enum value, the
...
- `packages/plugins/source-company-k2spacecorporation` (new)
