# Plan: 520 — Source Company Plugin: Redwood Materials
...
Redwood Materials's careers board is hosted on Greenhouse at the slug
`redwoodmaterials`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-redwoodmaterials` plugin.
- Deliverables: package files, `Site.REDWOOD_MATERIALS` enum value, the
...
- `packages/plugins/source-company-redwoodmaterials` (new)
