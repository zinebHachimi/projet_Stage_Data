# Plan: 488 — Source Company Plugin: Oklo
...
Oklo's careers board is hosted on Greenhouse at the slug
`oklo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-oklo` plugin.
- Deliverables: package files, `Site.OKLO` enum value, the
...
- `packages/plugins/source-company-oklo` (new)
