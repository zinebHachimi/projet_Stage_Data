# Plan: 205 — Source Company Plugin: Age Bold
...
Age Bold's careers board is hosted on Greenhouse at the slug
`agebold`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agebold` plugin.
- Deliverables: package files, `Site.AGEBOLD` enum value, the
...
- `packages/plugins/source-company-agebold` (new)
