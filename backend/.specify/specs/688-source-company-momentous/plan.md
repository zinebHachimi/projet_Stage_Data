# Plan: 688 — Source Company Plugin: Momentous
...
Momentous's careers board is hosted on Greenhouse at the slug
`momentous`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-momentous` plugin.
- Deliverables: package files, `Site.MOMENTOUS` enum value, the
...
- `packages/plugins/source-company-momentous` (new)
