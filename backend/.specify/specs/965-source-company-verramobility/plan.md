# Plan: 965 — Source Company Plugin: Verra Mobility
...
Verra Mobility's careers board is hosted on Greenhouse at the slug
`verramobility`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-verramobility` plugin.
- Deliverables: package files, `Site.VERRA_MOBILITY` enum value, the
...
- `packages/plugins/source-company-verramobility` (new)
