# Plan: 623 — Source Company Plugin: Ethos
...
Ethos's careers board is hosted on Greenhouse at the slug
`ethos`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ethos` plugin.
- Deliverables: package files, `Site.ETHOS` enum value, the
...
- `packages/plugins/source-company-ethos` (new)
