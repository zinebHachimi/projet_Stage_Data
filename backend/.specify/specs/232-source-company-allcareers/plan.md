# Plan: 232 — Source Company Plugin: Cortica - Neurodevelopmental
...
Cortica - Neurodevelopmental's careers board is hosted on Greenhouse at the slug
`allcareers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-allcareers` plugin.
- Deliverables: package files, `Site.ALLCAREERS` enum value, the
...
- `packages/plugins/source-company-allcareers` (new)
