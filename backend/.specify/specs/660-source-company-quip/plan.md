# Plan: 660 — Source Company Plugin: quip
...
quip's careers board is hosted on Greenhouse at the slug
`quip`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-quip` plugin.
- Deliverables: package files, `Site.QUIP` enum value, the
...
- `packages/plugins/source-company-quip` (new)
