# Plan: 865 — Source Company Plugin: Hyliion
...
Hyliion's careers board is hosted on Greenhouse at the slug
`hyliion`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hyliion` plugin.
- Deliverables: package files, `Site.HYLIION` enum value, the
...
- `packages/plugins/source-company-hyliion` (new)
