# Plan: 679 — Source Company Plugin: Seed Health
...
Seed Health's careers board is hosted on Greenhouse at the slug
`seed`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-seed` plugin.
- Deliverables: package files, `Site.SEED_HEALTH` enum value, the
...
- `packages/plugins/source-company-seed` (new)
