# Plan: 841 — Source Company Plugin: emnify
...
emnify's careers board is hosted on Greenhouse at the slug
`emnify`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-emnify` plugin.
- Deliverables: package files, `Site.EMNIFY` enum value, the
...
- `packages/plugins/source-company-emnify` (new)
