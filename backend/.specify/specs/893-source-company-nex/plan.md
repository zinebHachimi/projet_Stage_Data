# Plan: 893 — Source Company Plugin: Nex
...
Nex's careers board is hosted on Greenhouse at the slug
`nex`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nex` plugin.
- Deliverables: package files, `Site.NEX` enum value, the
...
- `packages/plugins/source-company-nex` (new)
