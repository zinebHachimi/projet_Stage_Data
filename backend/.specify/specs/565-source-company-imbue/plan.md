# Plan: 565 — Source Company Plugin: Imbue
...
Imbue's careers board is hosted on Greenhouse at the slug
`imbue`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-imbue` plugin.
- Deliverables: package files, `Site.IMBUE` enum value, the
...
- `packages/plugins/source-company-imbue` (new)
