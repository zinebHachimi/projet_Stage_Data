# Plan: 467 — Source Company Plugin: Huntress
...
Huntress's careers board is hosted on Greenhouse at the slug
`huntress`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-huntress` plugin.
- Deliverables: package files, `Site.HUNTRESS` enum value, the
...
- `packages/plugins/source-company-huntress` (new)
