# Plan: 727 — Source Company Plugin: Zola
...
Zola's careers board is hosted on Greenhouse at the slug
`zola`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-zola` plugin.
- Deliverables: package files, `Site.ZOLA` enum value, the
...
- `packages/plugins/source-company-zola` (new)
