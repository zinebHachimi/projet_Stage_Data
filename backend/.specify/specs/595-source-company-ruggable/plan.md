# Plan: 595 — Source Company Plugin: Ruggable
...
Ruggable's careers board is hosted on Greenhouse at the slug
`ruggable`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ruggable` plugin.
- Deliverables: package files, `Site.RUGGABLE` enum value, the
...
- `packages/plugins/source-company-ruggable` (new)
