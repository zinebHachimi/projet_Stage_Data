# Plan: 212 — Source Company Plugin: Ahrefs
...
Ahrefs's careers board is hosted on Greenhouse at the slug
`ahrefsjobs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ahrefsjobs` plugin.
- Deliverables: package files, `Site.AHREFSJOBS` enum value, the
...
- `packages/plugins/source-company-ahrefsjobs` (new)
