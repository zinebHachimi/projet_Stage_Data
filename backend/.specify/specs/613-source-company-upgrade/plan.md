# Plan: 613 — Source Company Plugin: Upgrade
...
Upgrade's careers board is hosted on Greenhouse at the slug
`upgrade`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-upgrade` plugin.
- Deliverables: package files, `Site.UPGRADE` enum value, the
...
- `packages/plugins/source-company-upgrade` (new)
