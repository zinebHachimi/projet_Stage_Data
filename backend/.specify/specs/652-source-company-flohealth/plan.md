# Plan: 652 — Source Company Plugin: Flo Health
...
Flo Health's careers board is hosted on Greenhouse at the slug
`flohealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-flohealth` plugin.
- Deliverables: package files, `Site.FLO_HEALTH` enum value, the
...
- `packages/plugins/source-company-flohealth` (new)
