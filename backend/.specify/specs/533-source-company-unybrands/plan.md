# Plan: 533 — Source Company Plugin: unybrands
...
unybrands's careers board is hosted on Greenhouse at the slug
`unybrands`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-unybrands` plugin.
- Deliverables: package files, `Site.UNYBRANDS` enum value, the
...
- `packages/plugins/source-company-unybrands` (new)
