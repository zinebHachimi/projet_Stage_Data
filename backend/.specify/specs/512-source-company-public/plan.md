# Plan: 512 — Source Company Plugin: Public
...
Public's careers board is hosted on Greenhouse at the slug
`public`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-public` plugin.
- Deliverables: package files, `Site.PUBLIC_INVEST` enum value, the
...
- `packages/plugins/source-company-public` (new)
