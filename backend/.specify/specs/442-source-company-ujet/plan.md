# Plan: 442 — Source Company Plugin: UJET
...
UJET's careers board is hosted on Greenhouse at the slug
`ujet`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ujet` plugin.
- Deliverables: package files, `Site.UJET` enum value, the
...
- `packages/plugins/source-company-ujet` (new)
