# Plan: 504 — Source Company Plugin: Hungryroot
...
Hungryroot's careers board is hosted on Greenhouse at the slug
`hungryroot`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hungryroot` plugin.
- Deliverables: package files, `Site.HUNGRYROOT` enum value, the
...
- `packages/plugins/source-company-hungryroot` (new)
