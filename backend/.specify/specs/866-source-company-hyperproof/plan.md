# Plan: 866 — Source Company Plugin: Hyperproof
...
Hyperproof's careers board is hosted on Greenhouse at the slug
`hyperproof`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hyperproof` plugin.
- Deliverables: package files, `Site.HYPERPROOF` enum value, the
...
- `packages/plugins/source-company-hyperproof` (new)
