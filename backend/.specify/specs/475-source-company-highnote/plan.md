# Plan: 475 — Source Company Plugin: Highnote
...
Highnote's careers board is hosted on Greenhouse at the slug
`highnote`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-highnote` plugin.
- Deliverables: package files, `Site.HIGHNOTE` enum value, the
...
- `packages/plugins/source-company-highnote` (new)
