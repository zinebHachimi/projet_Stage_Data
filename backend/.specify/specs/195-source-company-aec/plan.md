# Plan: 195 — Source Company Plugin: AEC
...
AEC's careers board is hosted on Greenhouse at the slug
`aec`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aec` plugin.
- Deliverables: package files, `Site.AEC` enum value, the
...
- `packages/plugins/source-company-aec` (new)
