# Plan: 710 — Source Company Plugin: FalconX
...
FalconX's careers board is hosted on Greenhouse at the slug
`falconx`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-falconx` plugin.
- Deliverables: package files, `Site.FALCONX` enum value, the
...
- `packages/plugins/source-company-falconx` (new)
