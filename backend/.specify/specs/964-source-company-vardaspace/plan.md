# Plan: 964 — Source Company Plugin: Varda Space Industries
...
Varda Space Industries's careers board is hosted on Greenhouse at the slug
`vardaspace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-vardaspace` plugin.
- Deliverables: package files, `Site.VARDA_SPACE_INDUSTRIES` enum value, the
...
- `packages/plugins/source-company-vardaspace` (new)
