# Plan: 816 — Source Company Plugin: Beam Therapeutics
...
Beam Therapeutics's careers board is hosted on Greenhouse at the slug
`beamtherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-beamtherapeutics` plugin.
- Deliverables: package files, `Site.BEAM_THERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-beamtherapeutics` (new)
