# Plan: 895 — Source Company Plugin: Nimble Robotics
...
Nimble Robotics's careers board is hosted on Greenhouse at the slug
`nimblerobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nimblerobotics` plugin.
- Deliverables: package files, `Site.NIMBLE_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-nimblerobotics` (new)
