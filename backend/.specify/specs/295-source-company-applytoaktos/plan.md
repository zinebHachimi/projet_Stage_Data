# Plan: 295 — Source Company Plugin: Aktos
...
Aktos's careers board is hosted on Greenhouse at the slug
`applytoaktos`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-applytoaktos` plugin.
- Deliverables: package files, `Site.APPLYTOAKTOS` enum value, the
...
- `packages/plugins/source-company-applytoaktos` (new)
