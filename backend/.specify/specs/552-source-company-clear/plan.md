# Plan: 552 — Source Company Plugin: CLEAR
...
CLEAR's careers board is hosted on Greenhouse at the slug
`clear`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-clear` plugin.
- Deliverables: package files, `Site.CLEAR` enum value, the
...
- `packages/plugins/source-company-clear` (new)
