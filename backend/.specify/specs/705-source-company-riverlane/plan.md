# Plan: 705 — Source Company Plugin: Riverlane
...
Riverlane's careers board is hosted on Greenhouse at the slug
`riverlane`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-riverlane` plugin.
- Deliverables: package files, `Site.RIVERLANE` enum value, the
...
- `packages/plugins/source-company-riverlane` (new)
