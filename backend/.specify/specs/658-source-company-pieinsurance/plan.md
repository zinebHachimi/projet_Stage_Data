# Plan: 658 — Source Company Plugin: Pie Insurance
...
Pie Insurance's careers board is hosted on Greenhouse at the slug
`pieinsurance`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pieinsurance` plugin.
- Deliverables: package files, `Site.PIE_INSURANCE` enum value, the
...
- `packages/plugins/source-company-pieinsurance` (new)
