# Plan: 233 — Source Company Plugin: Allen Control Systems
...
Allen Control Systems's careers board is hosted on Greenhouse at the slug
`allencontrolsystems`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-allencontrolsystems` plugin.
- Deliverables: package files, `Site.ALLENCONTROLSYSTEMS` enum value, the
...
- `packages/plugins/source-company-allencontrolsystems` (new)
