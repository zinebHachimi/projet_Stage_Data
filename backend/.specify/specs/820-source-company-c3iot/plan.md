# Plan: 820 — Source Company Plugin: C3 AI
...
C3 AI's careers board is hosted on Greenhouse at the slug
`c3iot`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-c3iot` plugin.
- Deliverables: package files, `Site.C3_AI` enum value, the
...
- `packages/plugins/source-company-c3iot` (new)
