# Plan: 491 — Source Company Plugin: Thunes
...
Thunes's careers board is hosted on Greenhouse at the slug
`thunes`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thunes` plugin.
- Deliverables: package files, `Site.THUNES` enum value, the
...
- `packages/plugins/source-company-thunes` (new)
