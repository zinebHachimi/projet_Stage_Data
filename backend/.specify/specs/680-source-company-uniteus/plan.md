# Plan: 680 — Source Company Plugin: Unite Us
...
Unite Us's careers board is hosted on Greenhouse at the slug
`uniteus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-uniteus` plugin.
- Deliverables: package files, `Site.UNITE_US` enum value, the
...
- `packages/plugins/source-company-uniteus` (new)
