# Plan: 527 — Source Company Plugin: Octave
...
Octave's careers board is hosted on Greenhouse at the slug
`octave`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-octave` plugin.
- Deliverables: package files, `Site.OCTAVE_HEALTH` enum value, the
...
- `packages/plugins/source-company-octave` (new)
