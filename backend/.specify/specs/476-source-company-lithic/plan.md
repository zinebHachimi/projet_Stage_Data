# Plan: 476 — Source Company Plugin: Lithic
...
Lithic's careers board is hosted on Greenhouse at the slug
`lithic`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-lithic` plugin.
- Deliverables: package files, `Site.LITHIC` enum value, the
...
- `packages/plugins/source-company-lithic` (new)
