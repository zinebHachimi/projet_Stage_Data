# Plan: 713 — Source Company Plugin: Securitize
...
Securitize's careers board is hosted on Greenhouse at the slug
`securitize`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-securitize` plugin.
- Deliverables: package files, `Site.SECURITIZE` enum value, the
...
- `packages/plugins/source-company-securitize` (new)
