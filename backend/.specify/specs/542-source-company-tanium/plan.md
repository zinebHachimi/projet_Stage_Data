# Plan: 542 — Source Company Plugin: Tanium
...
Tanium's careers board is hosted on Greenhouse at the slug
`tanium`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tanium` plugin.
- Deliverables: package files, `Site.TANIUM` enum value, the
...
- `packages/plugins/source-company-tanium` (new)
