# Plan: 790 — Source Company Plugin: Aurora Innovation
...
Aurora Innovation's careers board is hosted on Greenhouse at the slug
`aurorainnovation`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aurorainnovation` plugin.
- Deliverables: package files, `Site.AURORA_INNOVATION` enum value, the
...
- `packages/plugins/source-company-aurorainnovation` (new)
