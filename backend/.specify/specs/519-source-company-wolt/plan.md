# Plan: 519 — Source Company Plugin: Wolt
...
Wolt's careers board is hosted on Greenhouse at the slug
`wolt`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-wolt` plugin.
- Deliverables: package files, `Site.WOLT` enum value, the
...
- `packages/plugins/source-company-wolt` (new)
