# Plan: 534 — Source Company Plugin: Yotpo
...
Yotpo's careers board is hosted on Greenhouse at the slug
`yotpo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-yotpo` plugin.
- Deliverables: package files, `Site.YOTPO` enum value, the
...
- `packages/plugins/source-company-yotpo` (new)
