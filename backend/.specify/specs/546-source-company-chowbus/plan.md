# Plan: 546 — Source Company Plugin: Chowbus
...
Chowbus's careers board is hosted on Greenhouse at the slug
`chowbus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-chowbus` plugin.
- Deliverables: package files, `Site.CHOWBUS` enum value, the
...
- `packages/plugins/source-company-chowbus` (new)
