# Plan: 833 — Source Company Plugin: dbt Labs
...
dbt Labs's careers board is hosted on Greenhouse at the slug
`dbtlabsinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-dbtlabsinc` plugin.
- Deliverables: package files, `Site.DBT_LABS` enum value, the
...
- `packages/plugins/source-company-dbtlabsinc` (new)
