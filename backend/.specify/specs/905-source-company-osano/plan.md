# Plan: 905 — Source Company Plugin: Osano
...
Osano's careers board is hosted on Greenhouse at the slug
`osano`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-osano` plugin.
- Deliverables: package files, `Site.OSANO` enum value, the
...
- `packages/plugins/source-company-osano` (new)
