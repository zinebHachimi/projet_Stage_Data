# Plan: 276 — Source Company Plugin: AOTI
...
AOTI's careers board is hosted on Greenhouse at the slug
`aoti`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aoti` plugin.
- Deliverables: package files, `Site.AOTI` enum value, the
...
- `packages/plugins/source-company-aoti` (new)
