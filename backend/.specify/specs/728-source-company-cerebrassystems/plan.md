# Plan: 728 — Source Company Plugin: Cerebras Systems
...
Cerebras Systems's careers board is hosted on Greenhouse at the slug
`cerebrassystems`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cerebrassystems` plugin.
- Deliverables: package files, `Site.CEREBRAS_SYSTEMS` enum value, the
...
- `packages/plugins/source-company-cerebrassystems` (new)
