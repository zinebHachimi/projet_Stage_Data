# Plan: 776 — Source Company Plugin: Dyno Therapeutics
...
Dyno Therapeutics's careers board is hosted on Greenhouse at the slug
`dynotherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-dynotherapeutics` plugin.
- Deliverables: package files, `Site.DYNO_THERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-dynotherapeutics` (new)
