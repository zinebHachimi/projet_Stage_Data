# Plan: 683 — Source Company Plugin: Bitpanda
...
Bitpanda's careers board is hosted on Greenhouse at the slug
`bitpanda`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-bitpanda` plugin.
- Deliverables: package files, `Site.BITPANDA` enum value, the
...
- `packages/plugins/source-company-bitpanda` (new)
