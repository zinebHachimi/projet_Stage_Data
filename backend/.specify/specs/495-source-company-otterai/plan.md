# Plan: 495 — Source Company Plugin: Otter.ai
...
Otter.ai's careers board is hosted on Greenhouse at the slug
`otterai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-otterai` plugin.
- Deliverables: package files, `Site.OTTERAI` enum value, the
...
- `packages/plugins/source-company-otterai` (new)
