# Plan: 925 — Source Company Plugin: Sayari
...
Sayari's careers board is hosted on Greenhouse at the slug
`sayari`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sayari` plugin.
- Deliverables: package files, `Site.SAYARI` enum value, the
...
- `packages/plugins/source-company-sayari` (new)
