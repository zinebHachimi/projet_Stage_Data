# Plan: 563 — Source Company Plugin: Electric Hydrogen
...
Electric Hydrogen's careers board is hosted on Greenhouse at the slug
`eh2`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-eh2` plugin.
- Deliverables: package files, `Site.ELECTRIC_HYDROGEN` enum value, the
...
- `packages/plugins/source-company-eh2` (new)
