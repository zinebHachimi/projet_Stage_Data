# Plan: 949 — Source Company Plugin: TEGNA
...
TEGNA's careers board is hosted on Greenhouse at the slug
`tegnainc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tegnainc` plugin.
- Deliverables: package files, `Site.TEGNA` enum value, the
...
- `packages/plugins/source-company-tegnainc` (new)
