# Plan: 876 — Source Company Plugin: KH Aerospace
...
KH Aerospace's careers board is hosted on Greenhouse at the slug
`khaerospace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-khaerospace` plugin.
- Deliverables: package files, `Site.KH_AEROSPACE` enum value, the
...
- `packages/plugins/source-company-khaerospace` (new)
