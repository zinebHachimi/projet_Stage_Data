# Plan: 569 — Source Company Plugin: Valo Health
...
Valo Health's careers board is hosted on Greenhouse at the slug
`valohealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-valohealth` plugin.
- Deliverables: package files, `Site.VALO_HEALTH` enum value, the
...
- `packages/plugins/source-company-valohealth` (new)
