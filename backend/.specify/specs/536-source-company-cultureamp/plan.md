# Plan: 536 — Source Company Plugin: Culture Amp
...
Culture Amp's careers board is hosted on Greenhouse at the slug
`cultureamp`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cultureamp` plugin.
- Deliverables: package files, `Site.CULTURE_AMP` enum value, the
...
- `packages/plugins/source-company-cultureamp` (new)
