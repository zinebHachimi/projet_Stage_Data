# Plan: 450 — Source Company Plugin: Fireblocks
...
Fireblocks's careers board is hosted on Greenhouse at the slug
`fireblocks`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fireblocks` plugin.
- Deliverables: package files, `Site.FIREBLOCKS` enum value, the
...
- `packages/plugins/source-company-fireblocks` (new)
