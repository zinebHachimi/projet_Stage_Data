# Plan: 842 — Source Company Plugin: Energy Solutions
...
Energy Solutions's careers board is hosted on Greenhouse at the slug
`energysolutions`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-energysolutions` plugin.
- Deliverables: package files, `Site.ENERGY_SOLUTIONS` enum value, the
...
- `packages/plugins/source-company-energysolutions` (new)
