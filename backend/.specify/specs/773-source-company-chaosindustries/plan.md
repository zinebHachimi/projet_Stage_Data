# Plan: 773 — Source Company Plugin: CHAOS Industries
...
CHAOS Industries's careers board is hosted on Greenhouse at the slug
`chaosindustries`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-chaosindustries` plugin.
- Deliverables: package files, `Site.CHAOS_INDUSTRIES` enum value, the
...
- `packages/plugins/source-company-chaosindustries` (new)
