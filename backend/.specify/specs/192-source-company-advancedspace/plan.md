# Plan: 192 — Source Company Plugin: Advanced Space
...
Advanced Space's careers board is hosted on Greenhouse at the slug
`advancedspace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-advancedspace` plugin.
- Deliverables: package files, `Site.ADVANCEDSPACE` enum value, the
...
- `packages/plugins/source-company-advancedspace` (new)
