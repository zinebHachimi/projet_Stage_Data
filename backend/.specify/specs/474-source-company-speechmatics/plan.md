# Plan: 474 — Source Company Plugin: Speechmatics
...
Speechmatics's careers board is hosted on Greenhouse at the slug
`speechmatics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-speechmatics` plugin.
- Deliverables: package files, `Site.SPEECHMATICS` enum value, the
...
- `packages/plugins/source-company-speechmatics` (new)
