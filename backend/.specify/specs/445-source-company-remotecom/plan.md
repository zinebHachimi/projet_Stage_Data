# Plan: 445 — Source Company Plugin: Remote
...
Remote's careers board is hosted on Greenhouse at the slug
`remotecom`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-remotecom` plugin.
- Deliverables: package files, `Site.REMOTECOM` enum value, the
...
- `packages/plugins/source-company-remotecom` (new)
