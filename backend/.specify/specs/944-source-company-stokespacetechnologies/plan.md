# Plan: 944 — Source Company Plugin: Stoke Space
...
Stoke Space's careers board is hosted on Greenhouse at the slug
`stokespacetechnologies`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-stokespacetechnologies` plugin.
- Deliverables: package files, `Site.STOKE_SPACE` enum value, the
...
- `packages/plugins/source-company-stokespacetechnologies` (new)
