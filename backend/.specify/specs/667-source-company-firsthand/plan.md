# Plan: 667 — Source Company Plugin: firsthand Health
...
firsthand Health's careers board is hosted on Greenhouse at the slug
`firsthand`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-firsthand` plugin.
- Deliverables: package files, `Site.FIRSTHAND_HEALTH` enum value, the
...
- `packages/plugins/source-company-firsthand` (new)
