# Plan: 744 — Source Company Plugin: GoGuardian
...
GoGuardian's careers board is hosted on Greenhouse at the slug
`goguardian`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-goguardian` plugin.
- Deliverables: package files, `Site.GOGUARDIAN` enum value, the
...
- `packages/plugins/source-company-goguardian` (new)
