# Plan: 956 — Source Company Plugin: Third Wave Automation
...
Third Wave Automation's careers board is hosted on Greenhouse at the slug
`thirdwaveautomation`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thirdwaveautomation` plugin.
- Deliverables: package files, `Site.THIRD_WAVE_AUTOMATION` enum value, the
...
- `packages/plugins/source-company-thirdwaveautomation` (new)
