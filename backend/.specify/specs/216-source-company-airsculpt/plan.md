# Plan: 216 — Source Company Plugin: AirSculpt
...
AirSculpt's careers board is hosted on Greenhouse at the slug
`airsculpt`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-airsculpt` plugin.
- Deliverables: package files, `Site.AIRSCULPT` enum value, the
...
- `packages/plugins/source-company-airsculpt` (new)
