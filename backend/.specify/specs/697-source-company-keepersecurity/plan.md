# Plan: 697 — Source Company Plugin: Keeper Security
...
Keeper Security's careers board is hosted on Greenhouse at the slug
`keepersecurity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-keepersecurity` plugin.
- Deliverables: package files, `Site.KEEPER_SECURITY` enum value, the
...
- `packages/plugins/source-company-keepersecurity` (new)
