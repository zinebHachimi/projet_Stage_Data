# Plan: 846 — Source Company Plugin: Federato
...
Federato's careers board is hosted on Greenhouse at the slug
`federato`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-federato` plugin.
- Deliverables: package files, `Site.FEDERATO` enum value, the
...
- `packages/plugins/source-company-federato` (new)
