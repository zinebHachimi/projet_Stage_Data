# Plan: 821 — Source Company Plugin: Cabify
...
Cabify's careers board is hosted on Greenhouse at the slug
`cabify`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cabify` plugin.
- Deliverables: package files, `Site.CABIFY` enum value, the
...
- `packages/plugins/source-company-cabify` (new)
