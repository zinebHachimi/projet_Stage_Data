# Plan: 887 — Source Company Plugin: MrBeast (Beast Industries)
...
MrBeast (Beast Industries)'s careers board is hosted on Greenhouse at the slug
`mrbeastyoutube`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mrbeastyoutube` plugin.
- Deliverables: package files, `Site.MRBEAST_BEAST_INDUSTRIES` enum value, the
...
- `packages/plugins/source-company-mrbeastyoutube` (new)
