# Plan: 669 — Source Company Plugin: Form Health
...
Form Health's careers board is hosted on Greenhouse at the slug
`formhealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-formhealth` plugin.
- Deliverables: package files, `Site.FORM_HEALTH` enum value, the
...
- `packages/plugins/source-company-formhealth` (new)
