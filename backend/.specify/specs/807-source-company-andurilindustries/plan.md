# Plan: 807 — Source Company Plugin: Anduril Industries
...
Anduril Industries's careers board is hosted on Greenhouse at the slug
`andurilindustries`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-andurilindustries` plugin.
- Deliverables: package files, `Site.ANDURIL_INDUSTRIES` enum value, the
...
- `packages/plugins/source-company-andurilindustries` (new)
