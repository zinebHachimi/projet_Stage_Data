# Plan: 959 — Source Company Plugin: Transmit Security
...
Transmit Security's careers board is hosted on Greenhouse at the slug
`transmitsecurity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-transmitsecurity` plugin.
- Deliverables: package files, `Site.TRANSMIT_SECURITY` enum value, the
...
- `packages/plugins/source-company-transmitsecurity` (new)
