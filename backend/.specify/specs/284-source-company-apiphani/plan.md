# Plan: 284 — Source Company Plugin: apiphani
...
apiphani's careers board is hosted on Greenhouse at the slug
`apiphani`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apiphani` plugin.
- Deliverables: package files, `Site.APIPHANI` enum value, the
...
- `packages/plugins/source-company-apiphani` (new)
