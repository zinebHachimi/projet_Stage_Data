# Plan: 785 — Source Company Plugin: Slingshot Aerospace
...
Slingshot Aerospace's careers board is hosted on Greenhouse at the slug
`slingshotaerospace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-slingshotaerospace` plugin.
- Deliverables: package files, `Site.SLINGSHOT_AEROSPACE` enum value, the
...
- `packages/plugins/source-company-slingshotaerospace` (new)
