# Plan: 544 — Source Company Plugin: Figure
...
Figure's careers board is hosted on Greenhouse at the slug
`figureai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-figureai` plugin.
- Deliverables: package files, `Site.FIGURE` enum value, the
...
- `packages/plugins/source-company-figureai` (new)
