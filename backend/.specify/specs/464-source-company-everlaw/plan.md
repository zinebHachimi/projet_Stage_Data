# Plan: 464 — Source Company Plugin: Everlaw
...
Everlaw's careers board is hosted on Greenhouse at the slug
`everlaw`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-everlaw` plugin.
- Deliverables: package files, `Site.EVERLAW` enum value, the
...
- `packages/plugins/source-company-everlaw` (new)
