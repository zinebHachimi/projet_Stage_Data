# Plan: 649 — Source Company Plugin: Clara
...
Clara's careers board is hosted on Greenhouse at the slug
`clara`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-clara` plugin.
- Deliverables: package files, `Site.CLARA` enum value, the
...
- `packages/plugins/source-company-clara` (new)
