# Plan: 428 — Source Company Plugin: Ripple
...
Ripple's careers board is hosted on Greenhouse at the slug
`ripple`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ripple` plugin.
- Deliverables: package files, `Site.RIPPLE` enum value, the
...
- `packages/plugins/source-company-ripple` (new)
