# Plan: 775 — Source Company Plugin: Cortica
...
Cortica's careers board is hosted on Greenhouse at the slug
`cortica`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cortica` plugin.
- Deliverables: package files, `Site.CORTICA` enum value, the
...
- `packages/plugins/source-company-cortica` (new)
