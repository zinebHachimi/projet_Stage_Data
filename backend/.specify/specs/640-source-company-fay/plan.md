# Plan: 640 — Source Company Plugin: Fay
...
Fay's careers board is hosted on Greenhouse at the slug
`fay`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fay` plugin.
- Deliverables: package files, `Site.FAY` enum value, the
...
- `packages/plugins/source-company-fay` (new)
