# Plan: 883 — Source Company Plugin: mediasmart
...
mediasmart's careers board is hosted on Greenhouse at the slug
`mediasmart`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mediasmart` plugin.
- Deliverables: package files, `Site.MEDIASMART` enum value, the
...
- `packages/plugins/source-company-mediasmart` (new)
