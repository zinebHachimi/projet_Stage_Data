# Plan: 853 — Source Company Plugin: Freeform
...
Freeform's careers board is hosted on Greenhouse at the slug
`freeformfuturecorp`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-freeformfuturecorp` plugin.
- Deliverables: package files, `Site.FREEFORM` enum value, the
...
- `packages/plugins/source-company-freeformfuturecorp` (new)
