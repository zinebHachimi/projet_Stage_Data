# Plan: 278 — Source Company Plugin: Apartment Life
...
Apartment Life's careers board is hosted on Greenhouse at the slug
`apartmentlife`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apartmentlife` plugin.
- Deliverables: package files, `Site.APARTMENTLIFE` enum value, the
...
- `packages/plugins/source-company-apartmentlife` (new)
