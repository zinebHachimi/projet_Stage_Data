# Plan: 948 — Source Company Plugin: Tebra
...
Tebra's careers board is hosted on Greenhouse at the slug
`tebra`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tebra` plugin.
- Deliverables: package files, `Site.TEBRA` enum value, the
...
- `packages/plugins/source-company-tebra` (new)
