# Plan: 829 — Source Company Plugin: Colossal Biosciences
...
Colossal Biosciences's careers board is hosted on Greenhouse at the slug
`colossalbiosciences`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-colossalbiosciences` plugin.
- Deliverables: package files, `Site.COLOSSAL_BIOSCIENCES` enum value, the
...
- `packages/plugins/source-company-colossalbiosciences` (new)
