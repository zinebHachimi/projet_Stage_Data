# Plan: 265 — Source Company Plugin: Amwell
...
Amwell's careers board is hosted on Greenhouse at the slug
`amwell`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amwell` plugin.
- Deliverables: package files, `Site.AMWELL` enum value, the
...
- `packages/plugins/source-company-amwell` (new)
