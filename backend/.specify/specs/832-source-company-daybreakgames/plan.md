# Plan: 832 — Source Company Plugin: Daybreak Game Company
...
Daybreak Game Company's careers board is hosted on Greenhouse at the slug
`daybreakgames`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-daybreakgames` plugin.
- Deliverables: package files, `Site.DAYBREAK_GAME_COMPANY` enum value, the
...
- `packages/plugins/source-company-daybreakgames` (new)
