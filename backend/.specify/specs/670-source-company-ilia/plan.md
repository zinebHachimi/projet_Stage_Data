# Plan: 670 — Source Company Plugin: Ilia Digital
...
Ilia Digital's careers board is hosted on Greenhouse at the slug
`ilia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ilia` plugin.
- Deliverables: package files, `Site.ILIA_DIGITAL` enum value, the
...
- `packages/plugins/source-company-ilia` (new)
