# Plan: 855 — Source Company Plugin: Gatik AI
...
Gatik AI's careers board is hosted on Greenhouse at the slug
`gatikaiinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gatikaiinc` plugin.
- Deliverables: package files, `Site.GATIK_AI` enum value, the
...
- `packages/plugins/source-company-gatikaiinc` (new)
