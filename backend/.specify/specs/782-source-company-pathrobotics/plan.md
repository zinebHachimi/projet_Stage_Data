# Plan: 782 — Source Company Plugin: Path Robotics
...
Path Robotics's careers board is hosted on Greenhouse at the slug
`pathrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pathrobotics` plugin.
- Deliverables: package files, `Site.PATH_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-pathrobotics` (new)
