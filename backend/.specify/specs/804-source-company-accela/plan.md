# Plan: 804 — Source Company Plugin: Accela
...
Accela's careers board is hosted on Greenhouse at the slug
`accela`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-accela` plugin.
- Deliverables: package files, `Site.ACCELA` enum value, the
...
- `packages/plugins/source-company-accela` (new)
