# Plan: 711 — Source Company Plugin: OKX
...
OKX's careers board is hosted on Greenhouse at the slug
`okx`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-okx` plugin.
- Deliverables: package files, `Site.OKX` enum value, the
...
- `packages/plugins/source-company-okx` (new)
