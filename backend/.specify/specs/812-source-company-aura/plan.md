# Plan: 812 — Source Company Plugin: Aura
...
Aura's careers board is hosted on Greenhouse at the slug
`aura`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aura` plugin.
- Deliverables: package files, `Site.AURA` enum value, the
...
- `packages/plugins/source-company-aura` (new)
