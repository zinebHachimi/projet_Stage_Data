# Plan: 589 — Source Company Plugin: Future
...
Future's careers board is hosted on Greenhouse at the slug
`future`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-future` plugin.
- Deliverables: package files, `Site.FUTURE_FITNESS` enum value, the
...
- `packages/plugins/source-company-future` (new)
