# Plan: 778 — Source Company Plugin: Etched
...
Etched's careers board is hosted on Greenhouse at the slug
`etchedai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-etchedai` plugin.
- Deliverables: package files, `Site.ETCHED` enum value, the
...
- `packages/plugins/source-company-etchedai` (new)
