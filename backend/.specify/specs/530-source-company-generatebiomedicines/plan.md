# Plan: 530 — Source Company Plugin: Generate Biomedicines
...
Generate Biomedicines's careers board is hosted on Greenhouse at the slug
`generatebiomedicines`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-generatebiomedicines` plugin.
- Deliverables: package files, `Site.GENERATE_BIOMEDICINES` enum value, the
...
- `packages/plugins/source-company-generatebiomedicines` (new)
