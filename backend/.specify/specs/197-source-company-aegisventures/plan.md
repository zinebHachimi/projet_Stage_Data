# Plan: 197 — Source Company Plugin: Aegis Ventures
...
Aegis Ventures's careers board is hosted on Greenhouse at the slug
`aegisventures`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aegisventures` plugin.
- Deliverables: package files, `Site.AEGISVENTURES` enum value, the
...
- `packages/plugins/source-company-aegisventures` (new)
