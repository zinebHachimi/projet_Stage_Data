# Plan: 486 — Source Company Plugin: Nubank
...
Nubank's careers board is hosted on Greenhouse at the slug
`nubank`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nubank` plugin.
- Deliverables: package files, `Site.NUBANK` enum value, the
...
- `packages/plugins/source-company-nubank` (new)
