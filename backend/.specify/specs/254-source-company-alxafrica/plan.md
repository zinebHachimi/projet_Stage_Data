# Plan: 254 — Source Company Plugin: ALX Africa
...
ALX Africa's careers board is hosted on Greenhouse at the slug
`alxafrica`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alxafrica` plugin.
- Deliverables: package files, `Site.ALXAFRICA` enum value, the
...
- `packages/plugins/source-company-alxafrica` (new)
