# Plan: 204 — Source Company Plugin: AG1
...
AG1's careers board is hosted on Greenhouse at the slug
`ag1`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ag1` plugin.
- Deliverables: package files, `Site.AG1` enum value, the
...
- `packages/plugins/source-company-ag1` (new)
