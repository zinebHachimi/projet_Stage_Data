# Plan: 774 — Source Company Plugin: Cohere Health
...
Cohere Health's careers board is hosted on Greenhouse at the slug
`coherehealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-coherehealth` plugin.
- Deliverables: package files, `Site.COHERE_HEALTH` enum value, the
...
- `packages/plugins/source-company-coherehealth` (new)
