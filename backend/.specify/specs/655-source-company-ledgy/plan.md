# Plan: 655 — Source Company Plugin: Ledgy
...
Ledgy's careers board is hosted on Greenhouse at the slug
`ledgy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ledgy` plugin.
- Deliverables: package files, `Site.LEDGY` enum value, the
...
- `packages/plugins/source-company-ledgy` (new)
