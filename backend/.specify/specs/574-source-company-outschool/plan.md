# Plan: 574 — Source Company Plugin: Outschool
...
Outschool's careers board is hosted on Greenhouse at the slug
`outschool`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-outschool` plugin.
- Deliverables: package files, `Site.OUTSCHOOL` enum value, the
...
- `packages/plugins/source-company-outschool` (new)
