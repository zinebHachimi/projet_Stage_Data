# Plan: 286 — Source Company Plugin: Apogee Therapeutics
...
Apogee Therapeutics's careers board is hosted on Greenhouse at the slug
`apogeetherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apogeetherapeutics` plugin.
- Deliverables: package files, `Site.APOGEETHERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-apogeetherapeutics` (new)
