# Plan: 762 — Source Company Plugin: Form Bio
...
Form Bio's careers board is hosted on Greenhouse at the slug
`formbio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-formbio` plugin.
- Deliverables: package files, `Site.FORM_BIO` enum value, the
...
- `packages/plugins/source-company-formbio` (new)
