# Plan: 271 — Source Company Plugin: Ansa
...
Ansa's careers board is hosted on Greenhouse at the slug
`ansa`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ansa` plugin.
- Deliverables: package files, `Site.ANSA` enum value, the
...
- `packages/plugins/source-company-ansa` (new)
