# Plan: 896 — Source Company Plugin: NMI
...
NMI's careers board is hosted on Greenhouse at the slug
`nmi`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nmi` plugin.
- Deliverables: package files, `Site.NMI` enum value, the
...
- `packages/plugins/source-company-nmi` (new)
