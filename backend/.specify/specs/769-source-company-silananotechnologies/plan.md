# Plan: 769 — Source Company Plugin: Sila Nanotechnologies
...
Sila Nanotechnologies's careers board is hosted on Greenhouse at the slug
`silananotechnologies`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-silananotechnologies` plugin.
- Deliverables: package files, `Site.SILA_NANOTECHNOLOGIES` enum value, the
...
- `packages/plugins/source-company-silananotechnologies` (new)
