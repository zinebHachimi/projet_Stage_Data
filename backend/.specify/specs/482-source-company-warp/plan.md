# Plan: 482 — Source Company Plugin: Warp
...
Warp's careers board is hosted on Greenhouse at the slug
`warp`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-warp` plugin.
- Deliverables: package files, `Site.WARP` enum value, the
...
- `packages/plugins/source-company-warp` (new)
