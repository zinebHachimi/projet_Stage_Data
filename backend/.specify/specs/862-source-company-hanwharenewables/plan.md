# Plan: 862 — Source Company Plugin: Hanwha Renewables
...
Hanwha Renewables's careers board is hosted on Greenhouse at the slug
`hanwharenewables`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hanwharenewables` plugin.
- Deliverables: package files, `Site.HANWHA_RENEWABLES` enum value, the
...
- `packages/plugins/source-company-hanwharenewables` (new)
