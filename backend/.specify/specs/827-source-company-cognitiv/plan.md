# Plan: 827 — Source Company Plugin: Cognitiv
...
Cognitiv's careers board is hosted on Greenhouse at the slug
`cognitiv`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cognitiv` plugin.
- Deliverables: package files, `Site.COGNITIV` enum value, the
...
- `packages/plugins/source-company-cognitiv` (new)
