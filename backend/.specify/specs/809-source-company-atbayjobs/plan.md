# Plan: 809 — Source Company Plugin: At-Bay
...
At-Bay's careers board is hosted on Greenhouse at the slug
`atbayjobs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-atbayjobs` plugin.
- Deliverables: package files, `Site.AT_BAY` enum value, the
...
- `packages/plugins/source-company-atbayjobs` (new)
