# Plan: 586 — Source Company Plugin: Muon Space
...
Muon Space's careers board is hosted on Greenhouse at the slug
`muonspace`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-muonspace` plugin.
- Deliverables: package files, `Site.MUON_SPACE` enum value, the
...
- `packages/plugins/source-company-muonspace` (new)
