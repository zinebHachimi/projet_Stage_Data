# Plan: 934 — Source Company Plugin: SmartRent
...
SmartRent's careers board is hosted on Greenhouse at the slug
`smartrent`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-smartrent` plugin.
- Deliverables: package files, `Site.SMARTRENT` enum value, the
...
- `packages/plugins/source-company-smartrent` (new)
