# Plan: 659 — Source Company Plugin: QuintoAndar
...
QuintoAndar's careers board is hosted on Greenhouse at the slug
`quintoandar`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-quintoandar` plugin.
- Deliverables: package files, `Site.QUINTOANDAR` enum value, the
...
- `packages/plugins/source-company-quintoandar` (new)
