# Plan: 851 — Source Company Plugin: Forbes
...
Forbes's careers board is hosted on Greenhouse at the slug
`forbes`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-forbes` plugin.
- Deliverables: package files, `Site.FORBES` enum value, the
...
- `packages/plugins/source-company-forbes` (new)
