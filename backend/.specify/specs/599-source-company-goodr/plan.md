# Plan: 599 — Source Company Plugin: goodr
...
goodr's careers board is hosted on Greenhouse at the slug
`goodr`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-goodr` plugin.
- Deliverables: package files, `Site.GOODR` enum value, the
...
- `packages/plugins/source-company-goodr` (new)
