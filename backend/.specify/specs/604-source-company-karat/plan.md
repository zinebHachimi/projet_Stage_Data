# Plan: 604 — Source Company Plugin: Karat
...
Karat's careers board is hosted on Greenhouse at the slug
`karat`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-karat` plugin.
- Deliverables: package files, `Site.KARAT_INTERVIEWS` enum value, the
...
- `packages/plugins/source-company-karat` (new)
