# Plan: 639 — Source Company Plugin: Ezra
...
Ezra's careers board is hosted on Greenhouse at the slug
`ezra`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ezra` plugin.
- Deliverables: package files, `Site.EZRA` enum value, the
...
- `packages/plugins/source-company-ezra` (new)
