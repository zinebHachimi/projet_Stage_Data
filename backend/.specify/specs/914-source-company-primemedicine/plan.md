# Plan: 914 — Source Company Plugin: Prime Medicine
...
Prime Medicine's careers board is hosted on Greenhouse at the slug
`primemedicine`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-primemedicine` plugin.
- Deliverables: package files, `Site.PRIME_MEDICINE` enum value, the
...
- `packages/plugins/source-company-primemedicine` (new)
