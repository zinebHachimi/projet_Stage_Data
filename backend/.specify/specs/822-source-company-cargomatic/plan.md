# Plan: 822 — Source Company Plugin: Cargomatic
...
Cargomatic's careers board is hosted on Greenhouse at the slug
`cargomatic`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cargomatic` plugin.
- Deliverables: package files, `Site.CARGOMATIC` enum value, the
...
- `packages/plugins/source-company-cargomatic` (new)
