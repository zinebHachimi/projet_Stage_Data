# Plan: 748 — Source Company Plugin: Motional
...
Motional's careers board is hosted on Greenhouse at the slug
`motional`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-motional` plugin.
- Deliverables: package files, `Site.MOTIONAL` enum value, the
...
- `packages/plugins/source-company-motional` (new)
