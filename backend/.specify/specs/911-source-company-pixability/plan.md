# Plan: 911 — Source Company Plugin: Pixability
...
Pixability's careers board is hosted on Greenhouse at the slug
`pixability`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pixability` plugin.
- Deliverables: package files, `Site.PIXABILITY` enum value, the
...
- `packages/plugins/source-company-pixability` (new)
