# Plan: 592 — Source Company Plugin: Orchard
...
Orchard's careers board is hosted on Greenhouse at the slug
`orchard`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-orchard` plugin.
- Deliverables: package files, `Site.ORCHARD` enum value, the
...
- `packages/plugins/source-company-orchard` (new)
