# Plan: 912 — Source Company Plugin: Plus Power
...
Plus Power's careers board is hosted on Greenhouse at the slug
`pluspower`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pluspower` plugin.
- Deliverables: package files, `Site.PLUS_POWER` enum value, the
...
- `packages/plugins/source-company-pluspower` (new)
