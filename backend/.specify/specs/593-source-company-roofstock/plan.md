# Plan: 593 — Source Company Plugin: Roofstock
...
Roofstock's careers board is hosted on Greenhouse at the slug
`roofstock`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-roofstock` plugin.
- Deliverables: package files, `Site.ROOFSTOCK` enum value, the
...
- `packages/plugins/source-company-roofstock` (new)
