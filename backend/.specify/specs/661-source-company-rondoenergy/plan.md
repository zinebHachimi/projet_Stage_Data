# Plan: 661 — Source Company Plugin: Rondo Energy
...
Rondo Energy's careers board is hosted on Greenhouse at the slug
`rondoenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-rondoenergy` plugin.
- Deliverables: package files, `Site.RONDO_ENERGY` enum value, the
...
- `packages/plugins/source-company-rondoenergy` (new)
