# Plan: 808 — Source Company Plugin: Armis
...
Armis's careers board is hosted on Greenhouse at the slug
`armissecurity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-armissecurity` plugin.
- Deliverables: package files, `Site.ARMIS` enum value, the
...
- `packages/plugins/source-company-armissecurity` (new)
