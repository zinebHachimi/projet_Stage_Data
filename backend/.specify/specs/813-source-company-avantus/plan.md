# Plan: 813 — Source Company Plugin: Avantus
...
Avantus's careers board is hosted on Greenhouse at the slug
`avantus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-avantus` plugin.
- Deliverables: package files, `Site.AVANTUS` enum value, the
...
- `packages/plugins/source-company-avantus` (new)
