# Plan: 751 — Source Company Plugin: Newsela
...
Newsela's careers board is hosted on Greenhouse at the slug
`newsela`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-newsela` plugin.
- Deliverables: package files, `Site.NEWSELA` enum value, the
...
- `packages/plugins/source-company-newsela` (new)
