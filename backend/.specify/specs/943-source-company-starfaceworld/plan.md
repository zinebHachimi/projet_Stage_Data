# Plan: 943 — Source Company Plugin: Starface World
...
Starface World's careers board is hosted on Greenhouse at the slug
`starfaceworld`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-starfaceworld` plugin.
- Deliverables: package files, `Site.STARFACE_WORLD` enum value, the
...
- `packages/plugins/source-company-starfaceworld` (new)
