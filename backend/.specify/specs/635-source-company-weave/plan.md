# Plan: 635 — Source Company Plugin: Weave
...
Weave's careers board is hosted on Greenhouse at the slug
`weave`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-weave` plugin.
- Deliverables: package files, `Site.WEAVE` enum value, the
...
- `packages/plugins/source-company-weave` (new)
