# Plan: 886 — Source Company Plugin: Modernize Home Services
...
Modernize Home Services's careers board is hosted on Greenhouse at the slug
`modernize`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-modernize` plugin.
- Deliverables: package files, `Site.MODERNIZE_HOME_SERVICES` enum value, the
...
- `packages/plugins/source-company-modernize` (new)
