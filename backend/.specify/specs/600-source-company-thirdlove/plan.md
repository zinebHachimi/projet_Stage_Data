# Plan: 600 — Source Company Plugin: ThirdLove
...
ThirdLove's careers board is hosted on Greenhouse at the slug
`thirdlove`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thirdlove` plugin.
- Deliverables: package files, `Site.THIRDLOVE` enum value, the
...
- `packages/plugins/source-company-thirdlove` (new)
