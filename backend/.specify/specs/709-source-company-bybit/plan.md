# Plan: 709 — Source Company Plugin: Bybit
...
Bybit's careers board is hosted on Greenhouse at the slug
`bybit`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-bybit` plugin.
- Deliverables: package files, `Site.BYBIT` enum value, the
...
- `packages/plugins/source-company-bybit` (new)
