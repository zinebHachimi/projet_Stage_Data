# Plan: 277 — Source Company Plugin: Apaleo
...
Apaleo's careers board is hosted on Greenhouse at the slug
`apaleo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apaleo` plugin.
- Deliverables: package files, `Site.APALEO` enum value, the
...
- `packages/plugins/source-company-apaleo` (new)
