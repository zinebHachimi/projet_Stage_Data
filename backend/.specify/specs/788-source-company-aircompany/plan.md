# Plan: 788 — Source Company Plugin: AIR COMPANY
...
AIR COMPANY's careers board is hosted on Greenhouse at the slug
`aircompany`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aircompany` plugin.
- Deliverables: package files, `Site.AIR_COMPANY` enum value, the
...
- `packages/plugins/source-company-aircompany` (new)
