# Plan: 548 — Source Company Plugin: PathAI
...
PathAI's careers board is hosted on Greenhouse at the slug
`pathai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pathai` plugin.
- Deliverables: package files, `Site.PATHAI` enum value, the
...
- `packages/plugins/source-company-pathai` (new)
