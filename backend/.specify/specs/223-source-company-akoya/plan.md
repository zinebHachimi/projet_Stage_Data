# Plan: 223 — Source Company Plugin: Akoya
...
Akoya's careers board is hosted on Greenhouse at the slug
`akoya`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-akoya` plugin.
- Deliverables: package files, `Site.AKOYA` enum value, the
...
- `packages/plugins/source-company-akoya` (new)
