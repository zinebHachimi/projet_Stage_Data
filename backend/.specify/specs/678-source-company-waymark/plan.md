# Plan: 678 — Source Company Plugin: Waymark Health
...
Waymark Health's careers board is hosted on Greenhouse at the slug
`waymark`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-waymark` plugin.
- Deliverables: package files, `Site.WAYMARK_HEALTH` enum value, the
...
- `packages/plugins/source-company-waymark` (new)
