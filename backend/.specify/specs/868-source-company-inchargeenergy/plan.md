# Plan: 868 — Source Company Plugin: InCharge Energy
...
InCharge Energy's careers board is hosted on Greenhouse at the slug
`inchargeenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-inchargeenergy` plugin.
- Deliverables: package files, `Site.INCHARGE_ENERGY` enum value, the
...
- `packages/plugins/source-company-inchargeenergy` (new)
