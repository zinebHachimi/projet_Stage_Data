# Plan: 765 — Source Company Plugin: Komodo Health
...
Komodo Health's careers board is hosted on Greenhouse at the slug
`komodohealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-komodohealth` plugin.
- Deliverables: package files, `Site.KOMODO_HEALTH` enum value, the
...
- `packages/plugins/source-company-komodohealth` (new)
