# Plan: 598 — Source Company Plugin: Zenni Optical
...
Zenni Optical's careers board is hosted on Greenhouse at the slug
`zennioptical`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-zennioptical` plugin.
- Deliverables: package files, `Site.ZENNI_OPTICAL` enum value, the
...
- `packages/plugins/source-company-zennioptical` (new)
