# Plan: 231 — Source Company Plugin: Align Communications
...
Align Communications's careers board is hosted on Greenhouse at the slug
`align46`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-align46` plugin.
- Deliverables: package files, `Site.ALIGN46` enum value, the
...
- `packages/plugins/source-company-align46` (new)
