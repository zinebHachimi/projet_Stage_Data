# Plan: 750 — Source Company Plugin: Netradyne
...
Netradyne's careers board is hosted on Greenhouse at the slug
`netradyne`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-netradyne` plugin.
- Deliverables: package files, `Site.NETRADYNE` enum value, the
...
- `packages/plugins/source-company-netradyne` (new)
