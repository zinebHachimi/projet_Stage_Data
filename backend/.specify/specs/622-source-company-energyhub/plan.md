# Plan: 622 — Source Company Plugin: EnergyHub
...
EnergyHub's careers board is hosted on Greenhouse at the slug
`energyhub`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-energyhub` plugin.
- Deliverables: package files, `Site.ENERGYHUB` enum value, the
...
- `packages/plugins/source-company-energyhub` (new)
