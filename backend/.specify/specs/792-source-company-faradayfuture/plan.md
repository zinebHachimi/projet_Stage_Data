# Plan: 792 — Source Company Plugin: Faraday Future
...
Faraday Future's careers board is hosted on Greenhouse at the slug
`faradayfuture`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-faradayfuture` plugin.
- Deliverables: package files, `Site.FARADAY_FUTURE` enum value, the
...
- `packages/plugins/source-company-faradayfuture` (new)
