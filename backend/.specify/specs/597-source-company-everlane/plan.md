# Plan: 597 — Source Company Plugin: Everlane
...
Everlane's careers board is hosted on Greenhouse at the slug
`everlane`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-everlane` plugin.
- Deliverables: package files, `Site.EVERLANE` enum value, the
...
- `packages/plugins/source-company-everlane` (new)
