# Plan: 487 — Source Company Plugin: CookUnity
...
CookUnity's careers board is hosted on Greenhouse at the slug
`cookunity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cookunity` plugin.
- Deliverables: package files, `Site.COOKUNITY` enum value, the
...
- `packages/plugins/source-company-cookunity` (new)
