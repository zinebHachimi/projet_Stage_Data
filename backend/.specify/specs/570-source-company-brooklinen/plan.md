# Plan: 570 — Source Company Plugin: Brooklinen
...
Brooklinen's careers board is hosted on Greenhouse at the slug
`brooklinen`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-brooklinen` plugin.
- Deliverables: package files, `Site.BROOKLINEN` enum value, the
...
- `packages/plugins/source-company-brooklinen` (new)
