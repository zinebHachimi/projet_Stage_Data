# Plan: 209 — Source Company Plugin: Agilysys
...
Agilysys's careers board is hosted on Greenhouse at the slug
`agilysys`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agilysys` plugin.
- Deliverables: package files, `Site.AGILYSYS` enum value, the
...
- `packages/plugins/source-company-agilysys` (new)
