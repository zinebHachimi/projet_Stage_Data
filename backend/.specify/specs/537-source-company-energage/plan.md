# Plan: 537 — Source Company Plugin: Energage
...
Energage's careers board is hosted on Greenhouse at the slug
`energage`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-energage` plugin.
- Deliverables: package files, `Site.ENERGAGE` enum value, the
...
- `packages/plugins/source-company-energage` (new)
