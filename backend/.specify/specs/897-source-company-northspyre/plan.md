# Plan: 897 — Source Company Plugin: Northspyre
...
Northspyre's careers board is hosted on Greenhouse at the slug
`northspyre`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-northspyre` plugin.
- Deliverables: package files, `Site.NORTHSPYRE` enum value, the
...
- `packages/plugins/source-company-northspyre` (new)
