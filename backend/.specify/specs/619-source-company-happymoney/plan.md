# Plan: 619 — Source Company Plugin: Happy Money
...
Happy Money's careers board is hosted on Greenhouse at the slug
`happymoney`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-happymoney` plugin.
- Deliverables: package files, `Site.HAPPY_MONEY` enum value, the
...
- `packages/plugins/source-company-happymoney` (new)
