# Plan: 974 — Source Company Plugin: Zynga
...
Zynga's careers board is hosted on Greenhouse at the slug
`zyngacareers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-zyngacareers` plugin.
- Deliverables: package files, `Site.ZYNGA` enum value, the
...
- `packages/plugins/source-company-zyngacareers` (new)
