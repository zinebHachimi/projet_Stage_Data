# Plan: 702 — Source Company Plugin: Lightmatter
...
Lightmatter's careers board is hosted on Greenhouse at the slug
`lightmatter`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-lightmatter` plugin.
- Deliverables: package files, `Site.LIGHTMATTER` enum value, the
...
- `packages/plugins/source-company-lightmatter` (new)
