# Plan: 656 — Source Company Plugin: Mission Lane
...
Mission Lane's careers board is hosted on Greenhouse at the slug
`missionlane`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-missionlane` plugin.
- Deliverables: package files, `Site.MISSION_LANE` enum value, the
...
- `packages/plugins/source-company-missionlane` (new)
