# Plan: 755 — Source Company Plugin: Udacity
...
Udacity's careers board is hosted on Greenhouse at the slug
`udacity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-udacity` plugin.
- Deliverables: package files, `Site.UDACITY` enum value, the
...
- `packages/plugins/source-company-udacity` (new)
