# Plan: 701 — Source Company Plugin: Hometap
...
Hometap's careers board is hosted on Greenhouse at the slug
`hometap`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-hometap` plugin.
- Deliverables: package files, `Site.HOMETAP` enum value, the
...
- `packages/plugins/source-company-hometap` (new)
