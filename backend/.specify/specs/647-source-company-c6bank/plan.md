# Plan: 647 — Source Company Plugin: C6 Bank
...
C6 Bank's careers board is hosted on Greenhouse at the slug
`c6bank`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-c6bank` plugin.
- Deliverables: package files, `Site.C6_BANK` enum value, the
...
- `packages/plugins/source-company-c6bank` (new)
