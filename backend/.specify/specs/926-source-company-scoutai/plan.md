# Plan: 926 — Source Company Plugin: Scout AI
...
Scout AI's careers board is hosted on Greenhouse at the slug
`scoutai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-scoutai` plugin.
- Deliverables: package files, `Site.SCOUT_AI` enum value, the
...
- `packages/plugins/source-company-scoutai` (new)
