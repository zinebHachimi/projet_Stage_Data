# Plan: 716 — Source Company Plugin: Nebius
...
Nebius's careers board is hosted on Greenhouse at the slug
`nebius`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nebius` plugin.
- Deliverables: package files, `Site.NEBIUS` enum value, the
...
- `packages/plugins/source-company-nebius` (new)
