# Plan: 496 — Source Company Plugin: Observe.AI
...
Observe.AI's careers board is hosted on Greenhouse at the slug
`observeai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-observeai` plugin.
- Deliverables: package files, `Site.OBSERVEAI` enum value, the
...
- `packages/plugins/source-company-observeai` (new)
