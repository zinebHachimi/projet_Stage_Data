# Plan: 460 — Source Company Plugin: Tenstorrent
...
Tenstorrent's careers board is hosted on Greenhouse at the slug
`tenstorrent`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tenstorrent` plugin.
- Deliverables: package files, `Site.TENSTORRENT` enum value, the
...
- `packages/plugins/source-company-tenstorrent` (new)
