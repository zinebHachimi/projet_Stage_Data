# Plan: 753 — Source Company Plugin: Ophelos
...
Ophelos's careers board is hosted on Greenhouse at the slug
`ophelos`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ophelos` plugin.
- Deliverables: package files, `Site.OPHELOS` enum value, the
...
- `packages/plugins/source-company-ophelos` (new)
