# Plan: 452 — Source Company Plugin: project44
...
project44's careers board is hosted on Greenhouse at the slug
`project44`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-project44` plugin.
- Deliverables: package files, `Site.PROJECT44` enum value, the
...
- `packages/plugins/source-company-project44` (new)
