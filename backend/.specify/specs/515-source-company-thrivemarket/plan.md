# Plan: 515 — Source Company Plugin: Thrive Market
...
Thrive Market's careers board is hosted on Greenhouse at the slug
`thrivemarket`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thrivemarket` plugin.
- Deliverables: package files, `Site.THRIVE_MARKET` enum value, the
...
- `packages/plugins/source-company-thrivemarket` (new)
