# Plan: 289 — Source Company Plugin: APPARATUS
...
APPARATUS's careers board is hosted on Greenhouse at the slug
`apparatus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apparatus` plugin.
- Deliverables: package files, `Site.APPARATUS` enum value, the
...
- `packages/plugins/source-company-apparatus` (new)
