# Plan: 801 — Source Company Plugin: Ursa Major
...
Ursa Major's careers board is hosted on Greenhouse at the slug
`ursamajor`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ursamajor` plugin.
- Deliverables: package files, `Site.URSA_MAJOR` enum value, the
...
- `packages/plugins/source-company-ursamajor` (new)
