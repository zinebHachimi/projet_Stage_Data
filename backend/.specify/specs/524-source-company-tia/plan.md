# Plan: 524 — Source Company Plugin: Tia
...
Tia's careers board is hosted on Greenhouse at the slug
`tia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tia` plugin.
- Deliverables: package files, `Site.TIA_HEALTH` enum value, the
...
- `packages/plugins/source-company-tia` (new)
