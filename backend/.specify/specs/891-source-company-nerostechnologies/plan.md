# Plan: 891 — Source Company Plugin: Neros Technologies
...
Neros Technologies's careers board is hosted on Greenhouse at the slug
`nerostechnologies`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nerostechnologies` plugin.
- Deliverables: package files, `Site.NEROS_TECHNOLOGIES` enum value, the
...
- `packages/plugins/source-company-nerostechnologies` (new)
