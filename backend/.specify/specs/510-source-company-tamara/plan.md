# Plan: 510 — Source Company Plugin: Tamara
...
Tamara's careers board is hosted on Greenhouse at the slug
`tamara`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tamara` plugin.
- Deliverables: package files, `Site.TAMARA` enum value, the
...
- `packages/plugins/source-company-tamara` (new)
