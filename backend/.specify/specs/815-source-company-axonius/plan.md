# Plan: 815 — Source Company Plugin: Axonius
...
Axonius's careers board is hosted on Greenhouse at the slug
`axonius`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-axonius` plugin.
- Deliverables: package files, `Site.AXONIUS` enum value, the
...
- `packages/plugins/source-company-axonius` (new)
