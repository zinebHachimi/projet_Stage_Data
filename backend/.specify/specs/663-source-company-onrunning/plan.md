# Plan: 663 — Source Company Plugin: On Running
...
On Running's careers board is hosted on Greenhouse at the slug
`onrunning`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-onrunning` plugin.
- Deliverables: package files, `Site.ON_RUNNING` enum value, the
...
- `packages/plugins/source-company-onrunning` (new)
