# Plan: 251 — Source Company Plugin: ALU
...
ALU's careers board is hosted on Greenhouse at the slug
`alu`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alu` plugin.
- Deliverables: package files, `Site.ALU` enum value, the
...
- `packages/plugins/source-company-alu` (new)
