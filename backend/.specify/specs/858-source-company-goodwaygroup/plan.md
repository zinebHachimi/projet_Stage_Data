# Plan: 858 — Source Company Plugin: Goodway Group
...
Goodway Group's careers board is hosted on Greenhouse at the slug
`goodwaygroup`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-goodwaygroup` plugin.
- Deliverables: package files, `Site.GOODWAY_GROUP` enum value, the
...
- `packages/plugins/source-company-goodwaygroup` (new)
