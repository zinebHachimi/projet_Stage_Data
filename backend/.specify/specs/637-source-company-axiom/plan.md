# Plan: 637 — Source Company Plugin: Axiom
...
Axiom's careers board is hosted on Greenhouse at the slug
`axiom`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-axiom` plugin.
- Deliverables: package files, `Site.AXIOM` enum value, the
...
- `packages/plugins/source-company-axiom` (new)
