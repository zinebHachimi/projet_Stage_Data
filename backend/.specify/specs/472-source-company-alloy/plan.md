# Plan: 472 — Source Company Plugin: Alloy
...
Alloy's careers board is hosted on Greenhouse at the slug
`alloy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alloy` plugin.
- Deliverables: package files, `Site.ALLOY` enum value, the
...
- `packages/plugins/source-company-alloy` (new)
