# Plan: 584 — Source Company Plugin: Recursion
...
Recursion's careers board is hosted on Greenhouse at the slug
`recursionpharmaceuticals`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-recursionpharmaceuticals` plugin.
- Deliverables: package files, `Site.RECURSION` enum value, the
...
- `packages/plugins/source-company-recursionpharmaceuticals` (new)
