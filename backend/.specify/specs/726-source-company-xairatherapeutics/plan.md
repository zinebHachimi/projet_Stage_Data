# Plan: 726 — Source Company Plugin: Xaira Therapeutics
...
Xaira Therapeutics's careers board is hosted on Greenhouse at the slug
`xairatherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-xairatherapeutics` plugin.
- Deliverables: package files, `Site.XAIRA_THERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-xairatherapeutics` (new)
