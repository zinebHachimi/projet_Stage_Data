# Plan: 459 — Source Company Plugin: Navan
...
Navan's careers board is hosted on Greenhouse at the slug
`tripactions`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tripactions` plugin.
- Deliverables: package files, `Site.TRIPACTIONS` enum value, the
...
- `packages/plugins/source-company-tripactions` (new)
