# Plan: 745 — Source Company Plugin: HighRadius
...
HighRadius's careers board is hosted on Greenhouse at the slug
`highradius`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-highradius` plugin.
- Deliverables: package files, `Site.HIGHRADIUS` enum value, the
...
- `packages/plugins/source-company-highradius` (new)
