# Plan: 219 — Source Company Plugin: Aisera
...
Aisera's careers board is hosted on Greenhouse at the slug
`aiserajobs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aiserajobs` plugin.
- Deliverables: package files, `Site.AISERAJOBS` enum value, the
...
- `packages/plugins/source-company-aiserajobs` (new)
