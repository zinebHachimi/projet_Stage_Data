# Plan: 692 — Source Company Plugin: Saatva
...
Saatva's careers board is hosted on Greenhouse at the slug
`saatva`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-saatva` plugin.
- Deliverables: package files, `Site.SAATVA` enum value, the
...
- `packages/plugins/source-company-saatva` (new)
