# Plan: 694 — Source Company Plugin: Valence Labs
...
Valence Labs's careers board is hosted on Greenhouse at the slug
`valencelabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-valencelabs` plugin.
- Deliverables: package files, `Site.VALENCE_LABS` enum value, the
...
- `packages/plugins/source-company-valencelabs` (new)
