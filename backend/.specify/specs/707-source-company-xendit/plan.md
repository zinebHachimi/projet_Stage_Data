# Plan: 707 — Source Company Plugin: Xendit
...
Xendit's careers board is hosted on Greenhouse at the slug
`xendit`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-xendit` plugin.
- Deliverables: package files, `Site.XENDIT` enum value, the
...
- `packages/plugins/source-company-xendit` (new)
