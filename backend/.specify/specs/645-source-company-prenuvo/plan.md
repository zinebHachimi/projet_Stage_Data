# Plan: 645 — Source Company Plugin: Prenuvo
...
Prenuvo's careers board is hosted on Greenhouse at the slug
`prenuvo`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-prenuvo` plugin.
- Deliverables: package files, `Site.PRENUVO` enum value, the
...
- `packages/plugins/source-company-prenuvo` (new)
