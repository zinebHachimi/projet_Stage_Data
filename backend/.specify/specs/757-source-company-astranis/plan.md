# Plan: 757 — Source Company Plugin: Astranis
...
Astranis's careers board is hosted on Greenhouse at the slug
`astranis`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-astranis` plugin.
- Deliverables: package files, `Site.ASTRANIS` enum value, the
...
- `packages/plugins/source-company-astranis` (new)
