# Plan: 499 — Source Company Plugin: Narvar
...
Narvar's careers board is hosted on Greenhouse at the slug
`narvar`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-narvar` plugin.
- Deliverables: package files, `Site.NARVAR` enum value, the
...
- `packages/plugins/source-company-narvar` (new)
