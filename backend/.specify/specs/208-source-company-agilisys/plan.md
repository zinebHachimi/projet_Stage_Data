# Plan: 208 — Source Company Plugin: Agilisys
...
Agilisys's careers board is hosted on Greenhouse at the slug
`agilisys`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agilisys` plugin.
- Deliverables: package files, `Site.AGILISYS` enum value, the
...
- `packages/plugins/source-company-agilisys` (new)
