# Plan: 547 — Source Company Plugin: TabaPay
...
TabaPay's careers board is hosted on Greenhouse at the slug
`tabapay`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tabapay` plugin.
- Deliverables: package files, `Site.TABAPAY` enum value, the
...
- `packages/plugins/source-company-tabapay` (new)
