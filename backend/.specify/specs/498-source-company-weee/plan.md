# Plan: 498 — Source Company Plugin: Weee!
...
Weee!'s careers board is hosted on Greenhouse at the slug
`weee`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-weee` plugin.
- Deliverables: package files, `Site.WEEE` enum value, the
...
- `packages/plugins/source-company-weee` (new)
