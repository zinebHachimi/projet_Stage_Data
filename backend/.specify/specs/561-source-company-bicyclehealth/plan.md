# Plan: 561 — Source Company Plugin: Bicycle Health
...
Bicycle Health's careers board is hosted on Greenhouse at the slug
`bicyclehealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-bicyclehealth` plugin.
- Deliverables: package files, `Site.BICYCLE_HEALTH` enum value, the
...
- `packages/plugins/source-company-bicyclehealth` (new)
