# Plan: 687 — Source Company Plugin: Inceptive
...
Inceptive's careers board is hosted on Greenhouse at the slug
`inceptive`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-inceptive` plugin.
- Deliverables: package files, `Site.INCEPTIVE` enum value, the
...
- `packages/plugins/source-company-inceptive` (new)
