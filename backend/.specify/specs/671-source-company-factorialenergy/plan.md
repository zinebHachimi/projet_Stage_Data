# Plan: 671 — Source Company Plugin: Factorial Energy
...
Factorial Energy's careers board is hosted on Greenhouse at the slug
`factorialenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-factorialenergy` plugin.
- Deliverables: package files, `Site.FACTORIAL_ENERGY` enum value, the
...
- `packages/plugins/source-company-factorialenergy` (new)
