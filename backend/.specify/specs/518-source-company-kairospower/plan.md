# Plan: 518 — Source Company Plugin: Kairos Power
...
Kairos Power's careers board is hosted on Greenhouse at the slug
`kairospower`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-kairospower` plugin.
- Deliverables: package files, `Site.KAIROS_POWER` enum value, the
...
- `packages/plugins/source-company-kairospower` (new)
