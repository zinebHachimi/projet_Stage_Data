# Plan: 557 — Source Company Plugin: Vannevar Labs
...
Vannevar Labs's careers board is hosted on Greenhouse at the slug
`vannevarlabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-vannevarlabs` plugin.
- Deliverables: package files, `Site.VANNEVAR_LABS` enum value, the
...
- `packages/plugins/source-company-vannevarlabs` (new)
