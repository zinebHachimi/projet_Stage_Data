# Plan: 825 — Source Company Plugin: Checkbook
...
Checkbook's careers board is hosted on Greenhouse at the slug
`checkbook`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-checkbook` plugin.
- Deliverables: package files, `Site.CHECKBOOK` enum value, the
...
- `packages/plugins/source-company-checkbook` (new)
