# Plan: 196 — Source Company Plugin: Aechelon Technology
...
Aechelon Technology's careers board is hosted on Greenhouse at the slug
`aechelontechnology`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aechelontechnology` plugin.
- Deliverables: package files, `Site.AECHELONTECHNOLOGY` enum value, the
...
- `packages/plugins/source-company-aechelontechnology` (new)
