# Plan: 449 — Source Company Plugin: Together AI
...
Together AI's careers board is hosted on Greenhouse at the slug
`togetherai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-togetherai` plugin.
- Deliverables: package files, `Site.TOGETHERAI` enum value, the
...
- `packages/plugins/source-company-togetherai` (new)
