# Plan: 490 — Source Company Plugin: Zocdoc
...
Zocdoc's careers board is hosted on Greenhouse at the slug
`zocdoc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-zocdoc` plugin.
- Deliverables: package files, `Site.ZOCDOC` enum value, the
...
- `packages/plugins/source-company-zocdoc` (new)
