# Plan: 273 — Source Company Plugin: Anteriad 
...
Anteriad 's careers board is hosted on Greenhouse at the slug
`anteriad`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-anteriad` plugin.
- Deliverables: package files, `Site.ANTERIAD` enum value, the
...
- `packages/plugins/source-company-anteriad` (new)
