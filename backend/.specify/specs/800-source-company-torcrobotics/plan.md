# Plan: 800 — Source Company Plugin: Torc Robotics
...
Torc Robotics's careers board is hosted on Greenhouse at the slug
`torcrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-torcrobotics` plugin.
- Deliverables: package files, `Site.TORC_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-torcrobotics` (new)
