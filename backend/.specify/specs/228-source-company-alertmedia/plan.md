# Plan: 228 — Source Company Plugin: AlertMedia
...
AlertMedia's careers board is hosted on Greenhouse at the slug
`alertmedia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alertmedia` plugin.
- Deliverables: package files, `Site.ALERTMEDIA` enum value, the
...
- `packages/plugins/source-company-alertmedia` (new)
