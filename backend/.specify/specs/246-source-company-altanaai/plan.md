# Plan: 246 — Source Company Plugin: Altana 
...
Altana 's careers board is hosted on Greenhouse at the slug
`altanaai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-altanaai` plugin.
- Deliverables: package files, `Site.ALTANAAI` enum value, the
...
- `packages/plugins/source-company-altanaai` (new)
