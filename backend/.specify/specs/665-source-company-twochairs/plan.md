# Plan: 665 — Source Company Plugin: Two Chairs
...
Two Chairs's careers board is hosted on Greenhouse at the slug
`twochairs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-twochairs` plugin.
- Deliverables: package files, `Site.TWO_CHAIRS` enum value, the
...
- `packages/plugins/source-company-twochairs` (new)
