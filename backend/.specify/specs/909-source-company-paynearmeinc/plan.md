# Plan: 909 — Source Company Plugin: PayNearMe
...
PayNearMe's careers board is hosted on Greenhouse at the slug
`paynearmeinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-paynearmeinc` plugin.
- Deliverables: package files, `Site.PAYNEARME` enum value, the
...
- `packages/plugins/source-company-paynearmeinc` (new)
