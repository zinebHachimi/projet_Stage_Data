# Plan: 210 — Source Company Plugin: Agoda
...
Agoda's careers board is hosted on Greenhouse at the slug
`agoda`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-agoda` plugin.
- Deliverables: package files, `Site.AGODA` enum value, the
...
- `packages/plugins/source-company-agoda` (new)
