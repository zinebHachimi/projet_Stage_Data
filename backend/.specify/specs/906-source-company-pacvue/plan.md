# Plan: 906 — Source Company Plugin: Pacvue
...
Pacvue's careers board is hosted on Greenhouse at the slug
`pacvue`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pacvue` plugin.
- Deliverables: package files, `Site.PACVUE` enum value, the
...
- `packages/plugins/source-company-pacvue` (new)
