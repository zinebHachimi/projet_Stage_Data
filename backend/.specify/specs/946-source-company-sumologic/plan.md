# Plan: 946 — Source Company Plugin: Sumo Logic
...
Sumo Logic's careers board is hosted on Greenhouse at the slug
`sumologic`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-sumologic` plugin.
- Deliverables: package files, `Site.SUMO_LOGIC` enum value, the
...
- `packages/plugins/source-company-sumologic` (new)
