# Plan: 681 — Source Company Plugin: Banyan Infrastructure
...
Banyan Infrastructure's careers board is hosted on Greenhouse at the slug
`banyaninfrastructure`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-banyaninfrastructure` plugin.
- Deliverables: package files, `Site.BANYAN_INFRASTRUCTURE` enum value, the
...
- `packages/plugins/source-company-banyaninfrastructure` (new)
