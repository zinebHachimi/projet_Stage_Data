# Plan: 269 — Source Company Plugin: Schwarzman Animal Medical Center
...
Schwarzman Animal Medical Center's careers board is hosted on Greenhouse at the slug
`animalmedicalcenter`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-animalmedicalcenter` plugin.
- Deliverables: package files, `Site.ANIMALMEDICALCENTER` enum value, the
...
- `packages/plugins/source-company-animalmedicalcenter` (new)
