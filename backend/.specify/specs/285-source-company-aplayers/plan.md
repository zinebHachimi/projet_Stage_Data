# Plan: 285 — Source Company Plugin: MrBeast Contract Jobs
...
MrBeast Contract Jobs's careers board is hosted on Greenhouse at the slug
`aplayers`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aplayers` plugin.
- Deliverables: package files, `Site.APLAYERS` enum value, the
...
- `packages/plugins/source-company-aplayers` (new)
