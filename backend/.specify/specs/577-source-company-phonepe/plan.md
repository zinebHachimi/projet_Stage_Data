# Plan: 577 — Source Company Plugin: PhonePe
...
PhonePe's careers board is hosted on Greenhouse at the slug
`phonepe`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-phonepe` plugin.
- Deliverables: package files, `Site.PHONEPE` enum value, the
...
- `packages/plugins/source-company-phonepe` (new)
