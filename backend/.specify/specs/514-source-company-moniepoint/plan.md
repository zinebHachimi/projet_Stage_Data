# Plan: 514 — Source Company Plugin: Moniepoint
...
Moniepoint's careers board is hosted on Greenhouse at the slug
`moniepoint`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-moniepoint` plugin.
- Deliverables: package files, `Site.MONIEPOINT` enum value, the
...
- `packages/plugins/source-company-moniepoint` (new)
