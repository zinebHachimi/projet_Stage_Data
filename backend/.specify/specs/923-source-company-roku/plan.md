# Plan: 923 — Source Company Plugin: Roku
...
Roku's careers board is hosted on Greenhouse at the slug
`roku`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-roku` plugin.
- Deliverables: package files, `Site.ROKU` enum value, the
...
- `packages/plugins/source-company-roku` (new)
