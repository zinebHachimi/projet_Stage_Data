# Plan: 772 — Source Company Plugin: Carbon Robotics
...
Carbon Robotics's careers board is hosted on Greenhouse at the slug
`carbonrobotics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-carbonrobotics` plugin.
- Deliverables: package files, `Site.CARBON_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-carbonrobotics` (new)
