# Plan: 892 — Source Company Plugin: New Leaf Energy
...
New Leaf Energy's careers board is hosted on Greenhouse at the slug
`newleafenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-newleafenergy` plugin.
- Deliverables: package files, `Site.NEW_LEAF_ENERGY` enum value, the
...
- `packages/plugins/source-company-newleafenergy` (new)
