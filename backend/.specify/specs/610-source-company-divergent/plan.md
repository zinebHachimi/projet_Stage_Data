# Plan: 610 — Source Company Plugin: Divergent
...
Divergent's careers board is hosted on Greenhouse at the slug
`divergent`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-divergent` plugin.
- Deliverables: package files, `Site.DIVERGENT` enum value, the
...
- `packages/plugins/source-company-divergent` (new)
