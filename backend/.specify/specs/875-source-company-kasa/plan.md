# Plan: 875 — Source Company Plugin: Kasa
...
Kasa's careers board is hosted on Greenhouse at the slug
`kasa`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-kasa` plugin.
- Deliverables: package files, `Site.KASA` enum value, the
...
- `packages/plugins/source-company-kasa` (new)
