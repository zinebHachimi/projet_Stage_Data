# Plan: 201 — Source Company Plugin: Affinity.co
...
Affinity.co's careers board is hosted on Greenhouse at the slug
`affinity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-affinity` plugin.
- Deliverables: package files, `Site.AFFINITY` enum value, the
...
- `packages/plugins/source-company-affinity` (new)
