# Plan: 818 — Source Company Plugin: Bot Auto
...
Bot Auto's careers board is hosted on Greenhouse at the slug
`botauto`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-botauto` plugin.
- Deliverables: package files, `Site.BOT_AUTO` enum value, the
...
- `packages/plugins/source-company-botauto` (new)
