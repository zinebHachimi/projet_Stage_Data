# Plan: 282 — Source Company Plugin: Apex Companies - CSW
...
Apex Companies - CSW's careers board is hosted on Greenhouse at the slug
`apexcompaniescsw`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-apexcompaniescsw` plugin.
- Deliverables: package files, `Site.APEXCOMPANIESCSW` enum value, the
...
- `packages/plugins/source-company-apexcompaniescsw` (new)
