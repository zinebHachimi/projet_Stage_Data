# Plan: 198 — Source Company Plugin: Aerospike
...
Aerospike's careers board is hosted on Greenhouse at the slug
`aerospike`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aerospike` plugin.
- Deliverables: package files, `Site.AEROSPIKE` enum value, the
...
- `packages/plugins/source-company-aerospike` (new)
