# Plan: 242 — Source Company Plugin: AlphaGrep Securities
...
AlphaGrep Securities's careers board is hosted on Greenhouse at the slug
`alphagrepsecurities`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alphagrepsecurities` plugin.
- Deliverables: package files, `Site.ALPHAGREPSECURITIES` enum value, the
...
- `packages/plugins/source-company-alphagrepsecurities` (new)
