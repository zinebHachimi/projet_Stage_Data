# Plan: 585 — Source Company Plugin: Spire Global
...
Spire Global's careers board is hosted on Greenhouse at the slug
`spire`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-spire` plugin.
- Deliverables: package files, `Site.SPIRE_GLOBAL` enum value, the
...
- `packages/plugins/source-company-spire` (new)
