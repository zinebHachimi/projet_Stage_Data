# Plan: 236 — Source Company Plugin: Aspire Living & Learning 
...
Aspire Living & Learning 's careers board is hosted on Greenhouse at the slug
`allinc`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-allinc` plugin.
- Deliverables: package files, `Site.ALLINC` enum value, the
...
- `packages/plugins/source-company-allinc` (new)
