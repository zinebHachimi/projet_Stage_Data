# Plan: 629 — Source Company Plugin: Openly
...
Openly's careers board is hosted on Greenhouse at the slug
`openly`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-openly` plugin.
- Deliverables: package files, `Site.OPENLY` enum value, the
...
- `packages/plugins/source-company-openly` (new)
