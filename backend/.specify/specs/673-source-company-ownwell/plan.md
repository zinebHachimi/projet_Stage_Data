# Plan: 673 — Source Company Plugin: Ownwell
...
Ownwell's careers board is hosted on Greenhouse at the slug
`ownwell`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-ownwell` plugin.
- Deliverables: package files, `Site.OWNWELL` enum value, the
...
- `packages/plugins/source-company-ownwell` (new)
