# Plan: 830 — Source Company Plugin: Customer.io
...
Customer.io's careers board is hosted on Greenhouse at the slug
`customerio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-customerio` plugin.
- Deliverables: package files, `Site.CUSTOMER_IO` enum value, the
...
- `packages/plugins/source-company-customerio` (new)
