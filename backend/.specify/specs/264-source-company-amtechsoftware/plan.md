# Plan: 264 — Source Company Plugin: Amtech Software
...
Amtech Software's careers board is hosted on Greenhouse at the slug
`amtechsoftware`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-amtechsoftware` plugin.
- Deliverables: package files, `Site.AMTECHSOFTWARE` enum value, the
...
- `packages/plugins/source-company-amtechsoftware` (new)
