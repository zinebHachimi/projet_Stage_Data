# Plan: 230 — Source Company Plugin: A-LIGN External
...
A-LIGN External's careers board is hosted on Greenhouse at the slug
`align`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-align` plugin.
- Deliverables: package files, `Site.ALIGN` enum value, the
...
- `packages/plugins/source-company-align` (new)
