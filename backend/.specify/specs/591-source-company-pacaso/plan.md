# Plan: 591 — Source Company Plugin: Pacaso
...
Pacaso's careers board is hosted on Greenhouse at the slug
`pacaso`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pacaso` plugin.
- Deliverables: package files, `Site.PACASO` enum value, the
...
- `packages/plugins/source-company-pacaso` (new)
