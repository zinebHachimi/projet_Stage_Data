# Plan: 783 — Source Company Plugin: Pivot Bio
...
Pivot Bio's careers board is hosted on Greenhouse at the slug
`pivotbio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pivotbio` plugin.
- Deliverables: package files, `Site.PIVOT_BIO` enum value, the
...
- `packages/plugins/source-company-pivotbio` (new)
