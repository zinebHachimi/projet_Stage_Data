# Plan: 643 — Source Company Plugin: Jumio
...
Jumio's careers board is hosted on Greenhouse at the slug
`jumio`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-jumio` plugin.
- Deliverables: package files, `Site.JUMIO` enum value, the
...
- `packages/plugins/source-company-jumio` (new)
