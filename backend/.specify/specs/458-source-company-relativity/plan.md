# Plan: 458 — Source Company Plugin: Relativity Space
...
Relativity Space's careers board is hosted on Greenhouse at the slug
`relativity`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-relativity` plugin.
- Deliverables: package files, `Site.RELATIVITY` enum value, the
...
- `packages/plugins/source-company-relativity` (new)
