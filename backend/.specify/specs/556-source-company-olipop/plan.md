# Plan: 556 — Source Company Plugin: OLIPOP
...
OLIPOP's careers board is hosted on Greenhouse at the slug
`olipop`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-olipop` plugin.
- Deliverables: package files, `Site.OLIPOP` enum value, the
...
- `packages/plugins/source-company-olipop` (new)
