# Plan: 951 — Source Company Plugin: Terran Orbital
...
Terran Orbital's careers board is hosted on Greenhouse at the slug
`terranorbitalcorporation`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-terranorbitalcorporation` plugin.
- Deliverables: package files, `Site.TERRAN_ORBITAL` enum value, the
...
- `packages/plugins/source-company-terranorbitalcorporation` (new)
