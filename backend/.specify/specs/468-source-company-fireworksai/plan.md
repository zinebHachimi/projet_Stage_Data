# Plan: 468 — Source Company Plugin: Fireworks AI
...
Fireworks AI's careers board is hosted on Greenhouse at the slug
`fireworksai`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fireworksai` plugin.
- Deliverables: package files, `Site.FIREWORKSAI` enum value, the
...
- `packages/plugins/source-company-fireworksai` (new)
