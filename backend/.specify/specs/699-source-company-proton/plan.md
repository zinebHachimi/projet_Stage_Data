# Plan: 699 — Source Company Plugin: Proton
...
Proton's careers board is hosted on Greenhouse at the slug
`proton`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-proton` plugin.
- Deliverables: package files, `Site.PROTON` enum value, the
...
- `packages/plugins/source-company-proton` (new)
