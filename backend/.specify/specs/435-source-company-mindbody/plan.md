# Plan: 435 — Source Company Plugin: Mindbody
...
Mindbody's careers board is hosted on Greenhouse at the slug
`mindbody`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mindbody` plugin.
- Deliverables: package files, `Site.MINDBODY` enum value, the
...
- `packages/plugins/source-company-mindbody` (new)
