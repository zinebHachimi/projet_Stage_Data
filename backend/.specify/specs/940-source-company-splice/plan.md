# Plan: 940 — Source Company Plugin: Splice
...
Splice's careers board is hosted on Greenhouse at the slug
`splice`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-splice` plugin.
- Deliverables: package files, `Site.SPLICE` enum value, the
...
- `packages/plugins/source-company-splice` (new)
