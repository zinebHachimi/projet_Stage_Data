# Plan: 606 — Source Company Plugin: Alo Yoga
...
Alo Yoga's careers board is hosted on Greenhouse at the slug
`aloyoga`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aloyoga` plugin.
- Deliverables: package files, `Site.ALO_YOGA` enum value, the
...
- `packages/plugins/source-company-aloyoga` (new)
