# Plan: 857 — Source Company Plugin: GlossGenius
...
GlossGenius's careers board is hosted on Greenhouse at the slug
`glossgenius`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-glossgenius` plugin.
- Deliverables: package files, `Site.GLOSSGENIUS` enum value, the
...
- `packages/plugins/source-company-glossgenius` (new)
