# Plan: 469 — Source Company Plugin: HeyGen
...
HeyGen's careers board is hosted on Greenhouse at the slug
`heygen`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-heygen` plugin.
- Deliverables: package files, `Site.HEYGEN` enum value, the
...
- `packages/plugins/source-company-heygen` (new)
