# Plan: 653 — Source Company Plugin: Harry's
...
Harry's's careers board is hosted on Greenhouse at the slug
`harrys`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-harrys` plugin.
- Deliverables: package files, `Site.HARRY_S` enum value, the
...
- `packages/plugins/source-company-harrys` (new)
