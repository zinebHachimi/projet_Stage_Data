# Plan: 779 — Source Company Plugin: Formic
...
Formic's careers board is hosted on Greenhouse at the slug
`formic`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-formic` plugin.
- Deliverables: package files, `Site.FORMIC` enum value, the
...
- `packages/plugins/source-company-formic` (new)
