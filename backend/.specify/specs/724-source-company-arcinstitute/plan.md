# Plan: 724 — Source Company Plugin: Arc Institute
...
Arc Institute's careers board is hosted on Greenhouse at the slug
`arcinstitute`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-arcinstitute` plugin.
- Deliverables: package files, `Site.ARC_INSTITUTE` enum value, the
...
- `packages/plugins/source-company-arcinstitute` (new)
