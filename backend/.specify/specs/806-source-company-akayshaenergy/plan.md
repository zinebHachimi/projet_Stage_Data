# Plan: 806 — Source Company Plugin: Akaysha Energy
...
Akaysha Energy's careers board is hosted on Greenhouse at the slug
`akayshaenergy`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-akayshaenergy` plugin.
- Deliverables: package files, `Site.AKAYSHA_ENERGY` enum value, the
...
- `packages/plugins/source-company-akayshaenergy` (new)
