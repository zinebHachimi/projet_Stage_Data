# Plan: 708 — Source Company Plugin: BetterHelp
...
BetterHelp's careers board is hosted on Greenhouse at the slug
`betterhelp`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-betterhelp` plugin.
- Deliverables: package files, `Site.BETTERHELP` enum value, the
...
- `packages/plugins/source-company-betterhelp` (new)
