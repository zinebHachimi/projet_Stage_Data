# Plan: 930 — Source Company Plugin: Shift Technology
...
Shift Technology's careers board is hosted on Greenhouse at the slug
`shifttechnology`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-shifttechnology` plugin.
- Deliverables: package files, `Site.SHIFT_TECHNOLOGY` enum value, the
...
- `packages/plugins/source-company-shifttechnology` (new)
