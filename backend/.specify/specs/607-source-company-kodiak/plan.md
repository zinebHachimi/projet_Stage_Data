# Plan: 607 — Source Company Plugin: Kodiak Robotics
...
Kodiak Robotics's careers board is hosted on Greenhouse at the slug
`kodiak`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-kodiak` plugin.
- Deliverables: package files, `Site.KODIAK_ROBOTICS` enum value, the
...
- `packages/plugins/source-company-kodiak` (new)
