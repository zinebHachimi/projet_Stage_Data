# Plan: 590 — Source Company Plugin: Zwift
...
Zwift's careers board is hosted on Greenhouse at the slug
`zwift`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-zwift` plugin.
- Deliverables: package files, `Site.ZWIFT` enum value, the
...
- `packages/plugins/source-company-zwift` (new)
