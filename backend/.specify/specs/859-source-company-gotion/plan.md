# Plan: 859 — Source Company Plugin: Gotion
...
Gotion's careers board is hosted on Greenhouse at the slug
`gotion`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gotion` plugin.
- Deliverables: package files, `Site.GOTION` enum value, the
...
- `packages/plugins/source-company-gotion` (new)
