# Plan: 580 — Source Company Plugin: Mejuri
...
Mejuri's careers board is hosted on Greenhouse at the slug
`mejuri`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mejuri` plugin.
- Deliverables: package files, `Site.MEJURI` enum value, the
...
- `packages/plugins/source-company-mejuri` (new)
