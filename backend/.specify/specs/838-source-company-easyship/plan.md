# Plan: 838 — Source Company Plugin: Easyship
...
Easyship's careers board is hosted on Greenhouse at the slug
`easyship`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-easyship` plugin.
- Deliverables: package files, `Site.EASYSHIP` enum value, the
...
- `packages/plugins/source-company-easyship` (new)
