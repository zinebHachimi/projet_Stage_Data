# Plan: 531 — Source Company Plugin: Oura
...
Oura's careers board is hosted on Greenhouse at the slug
`oura`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-oura` plugin.
- Deliverables: package files, `Site.OURA` enum value, the
...
- `packages/plugins/source-company-oura` (new)
