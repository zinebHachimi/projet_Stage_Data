# Plan: 529 — Source Company Plugin: Natera
...
Natera's careers board is hosted on Greenhouse at the slug
`natera`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-natera` plugin.
- Deliverables: package files, `Site.NATERA` enum value, the
...
- `packages/plugins/source-company-natera` (new)
