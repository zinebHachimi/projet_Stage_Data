# Plan: 908 — Source Company Plugin: Pathward
...
Pathward's careers board is hosted on Greenhouse at the slug
`pathward`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-pathward` plugin.
- Deliverables: package files, `Site.PATHWARD` enum value, the
...
- `packages/plugins/source-company-pathward` (new)
