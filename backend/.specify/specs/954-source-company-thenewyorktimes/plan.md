# Plan: 954 — Source Company Plugin: The New York Times
...
The New York Times's careers board is hosted on Greenhouse at the slug
`thenewyorktimes`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-thenewyorktimes` plugin.
- Deliverables: package files, `Site.THE_NEW_YORK_TIMES` enum value, the
...
- `packages/plugins/source-company-thenewyorktimes` (new)
