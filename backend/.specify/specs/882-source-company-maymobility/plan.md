# Plan: 882 — Source Company Plugin: May Mobility
...
May Mobility's careers board is hosted on Greenhouse at the slug
`maymobility`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-maymobility` plugin.
- Deliverables: package files, `Site.MAY_MOBILITY` enum value, the
...
- `packages/plugins/source-company-maymobility` (new)
