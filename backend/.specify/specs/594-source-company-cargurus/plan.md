# Plan: 594 — Source Company Plugin: CarGurus
...
CarGurus's careers board is hosted on Greenhouse at the slug
`cargurus`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-cargurus` plugin.
- Deliverables: package files, `Site.CARGURUS` enum value, the
...
- `packages/plugins/source-company-cargurus` (new)
