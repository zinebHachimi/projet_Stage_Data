# Plan: 704 — Source Company Plugin: Quilt
...
Quilt's careers board is hosted on Greenhouse at the slug
`quilt`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-quilt` plugin.
- Deliverables: package files, `Site.QUILT` enum value, the
...
- `packages/plugins/source-company-quilt` (new)
