# Plan: 572 — Source Company Plugin: Gymshark
...
Gymshark's careers board is hosted on Greenhouse at the slug
`gymshark`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-gymshark` plugin.
- Deliverables: package files, `Site.GYMSHARK` enum value, the
...
- `packages/plugins/source-company-gymshark` (new)
