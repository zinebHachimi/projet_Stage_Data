# Plan: 786 — Source Company Plugin: Sound Agriculture
...
Sound Agriculture's careers board is hosted on Greenhouse at the slug
`soundagriculture`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-soundagriculture` plugin.
- Deliverables: package files, `Site.SOUND_AGRICULTURE` enum value, the
...
- `packages/plugins/source-company-soundagriculture` (new)
