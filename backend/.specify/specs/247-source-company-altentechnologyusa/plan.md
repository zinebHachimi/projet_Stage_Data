# Plan: 247 — Source Company Plugin: ALTEN Technology USA
...
ALTEN Technology USA's careers board is hosted on Greenhouse at the slug
`altentechnologyusa`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-altentechnologyusa` plugin.
- Deliverables: package files, `Site.ALTENTECHNOLOGYUSA` enum value, the
...
- `packages/plugins/source-company-altentechnologyusa` (new)
