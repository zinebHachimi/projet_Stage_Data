# Plan: 632 — Source Company Plugin: SpaceX
...
SpaceX's careers board is hosted on Greenhouse at the slug
`spacex`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-spacex` plugin.
- Deliverables: package files, `Site.SPACEX` enum value, the
...
- `packages/plugins/source-company-spacex` (new)
