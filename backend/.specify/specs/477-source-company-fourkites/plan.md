# Plan: 477 — Source Company Plugin: FourKites
...
FourKites's careers board is hosted on Greenhouse at the slug
`fourkites`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fourkites` plugin.
- Deliverables: package files, `Site.FOURKITES` enum value, the
...
- `packages/plugins/source-company-fourkites` (new)
