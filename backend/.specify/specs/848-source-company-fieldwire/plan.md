# Plan: 848 — Source Company Plugin: Fieldwire
...
Fieldwire's careers board is hosted on Greenhouse at the slug
`fieldwire`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fieldwire` plugin.
- Deliverables: package files, `Site.FIELDWIRE` enum value, the
...
- `packages/plugins/source-company-fieldwire` (new)
