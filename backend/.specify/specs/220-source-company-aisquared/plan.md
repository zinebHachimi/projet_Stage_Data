# Plan: 220 — Source Company Plugin: AI Squared
...
AI Squared's careers board is hosted on Greenhouse at the slug
`aisquared`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aisquared` plugin.
- Deliverables: package files, `Site.AISQUARED` enum value, the
...
- `packages/plugins/source-company-aisquared` (new)
