# Plan: 817 — Source Company Plugin: Blockchain.com
...
Blockchain.com's careers board is hosted on Greenhouse at the slug
`blockchain`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-blockchain` plugin.
- Deliverables: package files, `Site.BLOCKCHAIN_COM` enum value, the
...
- `packages/plugins/source-company-blockchain` (new)
