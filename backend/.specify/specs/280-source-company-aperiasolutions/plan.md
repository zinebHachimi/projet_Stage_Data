# Plan: 280 — Source Company Plugin: Aperia
...
Aperia's careers board is hosted on Greenhouse at the slug
`aperiasolutions`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aperiasolutions` plugin.
- Deliverables: package files, `Site.APERIASOLUTIONS` enum value, the
...
- `packages/plugins/source-company-aperiasolutions` (new)
