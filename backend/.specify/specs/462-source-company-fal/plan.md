# Plan: 462 — Source Company Plugin: fal
...
fal's careers board is hosted on Greenhouse at the slug
`fal`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-fal` plugin.
- Deliverables: package files, `Site.FAL` enum value, the
...
- `packages/plugins/source-company-fal` (new)
