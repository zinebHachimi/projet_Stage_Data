# Plan: 952 — Source Company Plugin: Tessera Therapeutics
...
Tessera Therapeutics's careers board is hosted on Greenhouse at the slug
`tesseratherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-tesseratherapeutics` plugin.
- Deliverables: package files, `Site.TESSERA_THERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-tesseratherapeutics` (new)
