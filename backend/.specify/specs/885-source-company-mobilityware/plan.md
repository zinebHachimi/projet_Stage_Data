# Plan: 885 — Source Company Plugin: MobilityWare
...
MobilityWare's careers board is hosted on Greenhouse at the slug
`mobilityware`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-mobilityware` plugin.
- Deliverables: package files, `Site.MOBILITYWARE` enum value, the
...
- `packages/plugins/source-company-mobilityware` (new)
