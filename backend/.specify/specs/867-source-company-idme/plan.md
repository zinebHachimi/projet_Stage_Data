# Plan: 867 — Source Company Plugin: ID.me
...
ID.me's careers board is hosted on Greenhouse at the slug
`idme`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-idme` plugin.
- Deliverables: package files, `Site.ID_ME` enum value, the
...
- `packages/plugins/source-company-idme` (new)
