# Plan: 664 — Source Company Plugin: Charlie Health
...
Charlie Health's careers board is hosted on Greenhouse at the slug
`charliehealth`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-charliehealth` plugin.
- Deliverables: package files, `Site.CHARLIE_HEALTH` enum value, the
...
- `packages/plugins/source-company-charliehealth` (new)
