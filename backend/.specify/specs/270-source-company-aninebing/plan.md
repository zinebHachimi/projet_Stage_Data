# Plan: 270 — Source Company Plugin: ANINE BING
...
ANINE BING's careers board is hosted on Greenhouse at the slug
`aninebing`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aninebing` plugin.
- Deliverables: package files, `Site.ANINEBING` enum value, the
...
- `packages/plugins/source-company-aninebing` (new)
