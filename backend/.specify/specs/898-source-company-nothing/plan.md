# Plan: 898 — Source Company Plugin: Nothing
...
Nothing's careers board is hosted on Greenhouse at the slug
`nothing`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-nothing` plugin.
- Deliverables: package files, `Site.NOTHING` enum value, the
...
- `packages/plugins/source-company-nothing` (new)
