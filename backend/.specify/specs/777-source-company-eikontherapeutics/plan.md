# Plan: 777 — Source Company Plugin: Eikon Therapeutics
...
Eikon Therapeutics's careers board is hosted on Greenhouse at the slug
`eikontherapeutics`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-eikontherapeutics` plugin.
- Deliverables: package files, `Site.EIKON_THERAPEUTICS` enum value, the
...
- `packages/plugins/source-company-eikontherapeutics` (new)
