# Plan: 203 — Source Company Plugin: AfterShip
...
AfterShip's careers board is hosted on Greenhouse at the slug
`aftership`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-aftership` plugin.
- Deliverables: package files, `Site.AFTERSHIP` enum value, the
...
- `packages/plugins/source-company-aftership` (new)
