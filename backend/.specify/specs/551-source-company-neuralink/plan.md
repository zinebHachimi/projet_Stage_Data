# Plan: 551 — Source Company Plugin: Neuralink
...
Neuralink's careers board is hosted on Greenhouse at the slug
`neuralink`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-neuralink` plugin.
- Deliverables: package files, `Site.NEURALINK` enum value, the
...
- `packages/plugins/source-company-neuralink` (new)
