# Plan: 754 — Source Company Plugin: Oportun
...
Oportun's careers board is hosted on Greenhouse at the slug
`oportun`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-oportun` plugin.
- Deliverables: package files, `Site.OPORTUN` enum value, the
...
- `packages/plugins/source-company-oportun` (new)
