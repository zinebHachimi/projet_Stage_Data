# Plan: 249 — Source Company Plugin: Altos Labs
...
Altos Labs's careers board is hosted on Greenhouse at the slug
`altoslabs`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-altoslabs` plugin.
- Deliverables: package files, `Site.ALTOSLABS` enum value, the
...
- `packages/plugins/source-company-altoslabs` (new)
