# Plan: 244 — Source Company Plugin: AlphaSense India
...
AlphaSense India's careers board is hosted on Greenhouse at the slug
`alphasenseindia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-alphasenseindia` plugin.
- Deliverables: package files, `Site.ALPHASENSEINDIA` enum value, the
...
- `packages/plugins/source-company-alphasenseindia` (new)
