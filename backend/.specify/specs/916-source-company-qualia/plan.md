# Plan: 916 — Source Company Plugin: Qualia
...
Qualia's careers board is hosted on Greenhouse at the slug
`qualia`. This plugin mirrors the canonical variant-2 + D-08
...
- Goal: a registered, tested `source-company-qualia` plugin.
- Deliverables: package files, `Site.QUALIA` enum value, the
...
- `packages/plugins/source-company-qualia` (new)
